...
# 1. Remove all duplicate <section class="editorial-canvas ...">...</section> blocks
content = re.sub(r'<section class="editorial-canvas.*?</section>\s*', '', content, flags=re.DOTALL)

# 2. Define the single, clean, beautiful #about section
SINGLE_ABOUT_SECTION = """<!-- ABOUT: CINEMATIC EDITORIAL CANVAS -->
...
# Insert directly after home section or right before professional journey section
anchor = '<section id="timeline-pin-section"'
if anchor in content:
    content = content.replace(anchor, SINGLE_ABOUT_SECTION + '\n\n' + anchor)
    print("Successfully inserted single clean #about section.")
else:
    print("Could not find anchor <section id=\"timeline-pin-section\"")
