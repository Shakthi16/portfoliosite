...
# Make sure section #about is placed directly before #timeline-pin-section

SECTION_ABOUT_HTML = """<!-- ABOUT: CINEMATIC EDITORIAL CANVAS -->
<section class="editorial-canvas font-sans relative z-20 overflow-hidden bg-[#dbeafe] text-[#1F1F1F]" id="about" style="min-height: 2700px; background-image: linear-gradient(to bottom, rgba(219, 234, 254, 0.7), rgba(240, 249, 255, 0.85), rgba(250, 248, 245, 0.95)), url('sky_clouds_bg.png'); background-size: cover; background-position: center; background-repeat: no-repeat;">
  ...
  <div class="relative w-full max-w-[1400px] mx-auto px-6 lg:px-12 z-10 hidden md:block" id="timeline-container" style="height: 2700px;">
    ...
    <svg class="absolute inset-0 w-full h-full pointer-events-none z-[50]" id="timeline-svg" viewBox="0 0 1400 2700" preserveAspectRatio="xMidYMid meet">
      ...
      <path id="seg-0" class="journey-path" d="" fill="none" stroke="#475569" stroke-width="2.5" stroke-dasharray="8 8" stroke-opacity="0.9" stroke-linecap="round" stroke-linejoin="round" marker-end="url(#arrow-tip)" />
      ...
      <path id="seg-1" class="journey-path" d="" fill="none" stroke="#475569" stroke-width="2.5" stroke-dasharray="8 8" stroke-opacity="0.9" stroke-linecap="round" stroke-linejoin="round" marker-end="url(#arrow-tip)" />
      ...
      <path id="seg-2" class="journey-path" d="" fill="none" stroke="#475569" stroke-width="2.5" stroke-dasharray="8 8" stroke-opacity="0.9" stroke-linecap="round" stroke-linejoin="round" marker-end="url(#arrow-tip)" />
      ...
      <path id="seg-3" class="journey-path" d="" fill="none" stroke="#475569" stroke-width="2.5" stroke-dasharray="8 8" stroke-opacity="0.9" stroke-linecap="round" stroke-linejoin="round" marker-end="url(#arrow-tip)" />
      ...
      <path id="seg-4" class="journey-path" d="" fill="none" stroke="#475569" stroke-width="2.5" stroke-dasharray="8 8" stroke-opacity="0.9" stroke-linecap="round" stroke-linejoin="round" marker-end="url(#arrow-tip)" />
...
# Find where #timeline-pin-section is located
if '<section id="timeline-pin-section"' in content:
    content = content.replace('<section id="timeline-pin-section"', SECTION_ABOUT_HTML + '\n\n<section id="timeline-pin-section"')
    print("Inserted section #about right before #timeline-pin-section.")
else:
    print("Could not find #timeline-pin-section in content.")

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(content)

print("Successfully restored section #about into index.html.")
