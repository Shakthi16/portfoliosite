...
new_home = """<section id="home" style="position: relative; overflow: hidden; height: 100vh; min-height: 700px; width: 100vw; background-color: #fdfaf8; background-image: linear-gradient(#f0e9e4 1px, transparent 1px), linear-gradient(90deg, #f0e9e4 1px, transparent 1px); background-size: 50px 50px;">
  ...
  <!-- Define Floating Animations & SVG styles -->
  <style>
    @keyframes slowFloat {
    ...
    .float-item.delay-3 { animation-delay: 3s; }
    .float-item.delay-4 { animation-delay: 4s; }
    
    /* Cute SVG shapes to replace emojis */
    .cute-star {
  ...
  <svg style="display:none;">
    <defs>
      ...
      <g id="icon-heart">
        <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="none" stroke="url(#heart-grad)" stroke-width="2" />
      </g>
  ...
  <!-- Decorative SVG Elements (Replacing Text Emojis) -->
  <div class="float-item delay-1" style="position: absolute; top: 12%; left: 38%; --rot: 15deg;"><svg class="cute-star"><use href="#icon-star"/></svg></div>
  <div class="float-item delay-3" style="position: absolute; bottom: 25%; right: 28%; --rot: -10deg;"><svg class="cute-star"><use href="#icon-star"/></svg></div>
  <div class="float-item delay-2" style="position: absolute; top: 30%; right: 30%; --rot: 5deg;"><svg class="cute-heart"><use href="#icon-heart"/></svg></div>
  <div class="float-item delay-4" style="position: absolute; bottom: 15%; left: 45%; --rot: 45deg;"><svg class="cute-star" style="width:16px; height:16px;"><use href="#icon-star"/></svg></div>
  <div class="float-item delay-1" style="position: absolute; bottom: 35%; left: 28%; --rot: 0deg;"><svg class="cute-heart"><use href="#icon-heart"/></svg></div>
  <div class="float-item delay-3" style="position: absolute; top: 55%; right: 35%; --rot: 0deg;"><svg class="cute-heart" style="width:24px; height:24px;"><use href="#icon-heart"/></svg></div>
  <div class="float-item delay-2" style="position: absolute; bottom: 25%; right: 18%; --rot: -15deg;"><svg class="cute-star"><use href="#icon-star"/></svg></div>

  <!-- CENTER TITLE (Pushed fully to background, completely clear zone) -->
  ...
  <!-- 1. ID CARD (Top Left) -->
  <div class="floating-sticker float-item" style="top: 1%; left: 1%; z-index: 10; --rot: -5deg; transform-origin: top left; scale: 0.8;">
  ...
  <div class="floating-sticker float-item delay-2" style="top: 15%; left: 14%; z-index: 7; --rot: 2deg; scale: 0.85;">
  ...
  <div class="floating-sticker float-item delay-4" style="top: 4%; left: 18%; z-index: 8; --rot: -3deg; scale: 0.85;">
    ...
    <div class="torn-paper" style="width: 140px; padding: 25px 20px; background: #fff; box-shadow: 0 8px 15px rgba(0,0,0,0.05); border: 1px solid rgba(0,0,0,0.02); clip-path: polygon(0 0, 100% 0, 98% 100%, 0% 98%);">
      ...
      <ul style="list-style: none; padding: 0; margin: 0; font-size: 11px; color: #582a4b; font-family: 'Manrope', sans-serif !important; line-height: 2;">
        <li><svg class="cute-heart" style="width:8px; height:8px; margin-right:4px;"><use href="#icon-heart"/></svg> design flow</li>
        <li><svg class="cute-heart" style="width:8px; height:8px; margin-right:4px;"><use href="#icon-heart"/></svg> threat hunting</li>
        <li><svg class="cute-heart" style="width:8px; height:8px; margin-right:4px;"><use href="#icon-heart"/></svg> final year project</li>
        <li><svg class="cute-heart" style="width:8px; height:8px; margin-right:4px;"><use href="#icon-heart"/></svg> user research</li>
        <li><svg class="cute-heart" style="width:8px; height:8px; margin-right:4px;"><use href="#icon-heart"/></svg> gym + reset</li>
      </ul>
    </div>
  </div>

  <!-- 4. Design Journey Ticket (PUSHED RIGHT AWAY FROM CENTER) -->
  <div class="floating-sticker float-item delay-1" style="top: 4%; right: 18%; z-index: 8; --rot: 1deg; scale: 0.85;">
  ...
  <!-- 5. What Drives Me Note (PERFECT ALIGNMENT inside DAISY GRID) -->
  <div class="floating-sticker float-item delay-3" style="top: -2%; right: -2%; z-index: 6; --rot: -2deg; scale: 0.85;">
    <!-- Tape -->
    ...
    <!-- Adjusted padding to precisely constrain text right of the flowers -->
    <div style="width: 330px; height: 330px; background: url('notes.png') center/contain no-repeat; padding: 75px 40px 30px 145px; box-sizing: border-box; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.05)); display: flex; flex-direction: column;">
  ...
  <!-- 6. GIRL.PNG (Unblocked) -->
  <div class="floating-sticker float-item delay-2" style="top: 8%; right: 4%; z-index: 10; --rot: 2deg;">
  ...
  <div class="floating-sticker float-item delay-4" style="bottom: 30%; left: 1%; z-index: 9; --rot: -4deg; scale: 0.8; transform-origin: bottom left;">
  ...
  <!-- 8. "LESSONS I'M STILL LEARNING" Note using notes1.png (PERFECT ALIGNMENT) -->
  <div class="floating-sticker float-item delay-1" style="top: 45%; left: 18%; z-index: 7; --rot: 2deg; scale: 0.85;">
    <!-- Adjusted padding to center the list in the crumpled paper -->
  ...
  <!-- 9. 3 Polaroids -->
  <div class="floating-sticker float-item delay-3" style="top: 25%; right: 4%; width: 220px; height: 300px; z-index: 10; scale: 0.85; --rot: 0deg;">
    <!-- Purple pins -->
    <div class="polaroid-collage float-item delay-1" style="position: absolute; top: 0; left: 0; --rot: -8deg; width: 120px; padding: 8px 8px 25px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08); z-index: 1;">
    ...
    <div class="polaroid-collage float-item delay-2" style="position: absolute; top: 10px; right: 0; --rot: 12deg; width: 110px; padding: 8px 8px 25px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08); z-index: 2;">
    ...
    <div class="polaroid-collage float-item delay-4" style="position: absolute; top: 110px; left: 10px; --rot: -3deg; width: 120px; padding: 8px 8px 35px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.1); z-index: 3;">
    ...
    <div class="polaroid-collage float-item delay-1" style="position: absolute; top: 140px; right: 10px; --rot: 5deg; width: 100px; padding: 8px 8px 30px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.1); z-index: 4;">
  ...
  <!-- 10. Terminal Window -->
  <div class="floating-sticker float-item delay-2" style="bottom: 2%; left: 1%; z-index: 10; --rot: -2deg; transform-origin: bottom left; scale: 0.85;">
  ...
  <!-- 11. Dark Quote Note -->
  <div class="floating-sticker float-item delay-4" style="bottom: 3%; left: 22%; z-index: 12; --rot: 3deg; transform-origin: bottom center; scale: 0.85;">
    <!-- Tape -->
  ...
  <!-- 12. AGNI C2 Card -->
  <div class="floating-sticker float-item delay-1" style="bottom: 3%; left: 38%; z-index: 9; --rot: -1deg; transform-origin: bottom center; scale: 0.85;">
  ...
  <!-- 13. Tech Stack Grid -->
  <div class="floating-sticker float-item delay-3" style="bottom: 8%; right: 28%; z-index: 10; --rot: 2deg; transform-origin: bottom right; scale: 0.85;">
  ...
  <div class="floating-sticker float-item delay-2" style="bottom: 12%; right: 18%; z-index: 12; --rot: -3deg; transform-origin: bottom right; scale: 0.9;">
  ...
  <!-- 15. Vinyl Record -->
  <div class="floating-sticker float-item delay-1" style="bottom: -10%; right: -5%; z-index: 5; --rot: 15deg; scale: 0.9;">
  ...
  <!-- 16. Music Player -->
  <div class="floating-sticker float-item delay-4" style="bottom: 5%; right: 2%; z-index: 15; --rot: -4deg; transform-origin: bottom right; scale: 0.85;">
    <div style="width: 190px; padding: 20px; background: rgba(235, 213, 224, 0.85); backdrop-filter: blur(10px); border-radius: 12px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); border: 1px solid rgba(255,255,255,0.4);">
      <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px;">
        ...
        <svg class="cute-heart" style="width:12px; height:12px;"><use href="#icon-heart"/></svg>
      </div>
  ...
  <div class="floating-sticker float-item delay-2" style="top: 25%; right: 1%; z-index: 200 !important; --rot: 0deg; scale: 0.8;">
...
print("Home section rewritten: Added floating animations, SVG hearts/stars, cleared the center, and perfected note paddings.")
