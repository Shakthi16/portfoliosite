...
if start_pos != -1 and end_pos != -1:
    ...
    new_spread_1_html = '''          <!-- INNER PAGES SPREAD 1 (PAGES 01 & 02 - PERFECTLY ALIGNED ZERO-WHITESPACE REPLICATION) -->
          <div id="smriti-spread-1" class="w-full bg-[#FAF6EE] rounded-[18px] p-4 md:p-5 relative overflow-hidden text-left min-h-[530px] md:min-h-[560px] h-[530px] md:h-[560px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <!-- PAGE 01: LEFT SIDE -->
              <div class="flex flex-col justify-between space-y-2.5 text-left pr-0 md:pr-2 h-full">
                <!-- 1. Header & Sub-header -->
                <div>
                  <h3 class="text-3xl md:text-[38px] font-extrabold text-[#1C1917] mb-1 tracking-tight leading-none" style="font-family: 'Outfit', sans-serif;">Shakthi Sri</h3>
                  <div class="flex flex-wrap items-center gap-2 mb-2">
                    <span class="px-2.5 py-0.5 bg-[#E8D5CE] text-[#6B2137] text-[9.5px] font-bold rounded-full border border-[#D9BEB4] tracking-wider uppercase" style="font-family: 'Outfit', sans-serif;">DEVELOPER &amp; RESEARCHER</span>
                ...
                <div class="space-y-1.5 text-xs text-[#2C2C2C] font-medium" style="font-family: 'Patrick Hand', cursive !important;">
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-1">
                    ...
                    <span class="text-gray-600 text-[11px]">Research Intern</span>
                  </div>
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-1">
                    ...
                    <span class="text-gray-600 text-[11px]">Always Learning</span>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                  ...
                  <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-2xs relative">
                    ...
                    <span class="text-xs text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', cursive !important;">about me ヾ</span>
                    <ul class="text-[11.5px] text-[#2C2C2C] font-medium leading-tight space-y-1" style="font-family: 'Patrick Hand', cursive !important;">
                    ...
                    <span class="absolute bottom-1.5 right-2 text-[10px] text-[#6B2137]">♡</span>
                  </div>

                  <!-- TODAY Box -->
                  <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-2xs relative flex flex-col justify-between">
                    <div>
                      ...
                      <span class="text-[9px] font-mono font-bold text-gray-500 uppercase block mb-1">TODAY</span>
                      <p class="text-[11.5px] text-[#2C2C2C] font-medium leading-tight" style="font-family: 'Patrick Hand', cursive !important;">
                ...
                <div class="pt-2 border-t border-dashed border-amber-900/20 flex justify-between items-center gap-2">
                  <div class="bg-[#EFE5D8] px-3 py-2 rounded-lg text-[11px] text-[#2C2C2C] font-medium border border-amber-900/15" style="font-family: 'Patrick Hand', cursive !important;">
                  ...
                  <div class="text-right">
                    ...
                    <svg width="95" height="5" viewBox="0 0 95 5" class="ml-auto mt-0.5 opacity-60">
                      <path d="M2 3 C20 1, 60 1, 93 3" stroke="#541C2E" stroke-width="1.5" fill="none" stroke-linecap="round"/>
                    </svg>
                  </div>
                </div>
              </div>
              ...
              <!-- PAGE 02: RIGHT SIDE -->
              <div class="flex flex-col justify-between space-y-2.5 text-left pl-0 md:pl-2 h-full">
                <!-- 1. Top Row: Icons -->
                <div class="flex justify-between items-start">
                  <div class="text-center">
                    ...
                    <span class="block text-[10px] text-gray-700 mt-0.5" style="font-family: 'Patrick Hand', cursive !important;">breathe.png</span>
                  </div>
                ...
                <div class="grid grid-cols-12 gap-2.5 items-center">
                  <!-- currently ヾ -->
                  <div class="col-span-6 border border-dashed border-amber-900/30 rounded-xl p-3 bg-[#F8F3EA] h-full flex flex-col justify-center">
                    <span class="text-xs text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', cursive !important;">currently ヾ</span>
                    <ul class="text-[11px] text-[#2C2C2C] font-medium leading-tight space-y-0.5" style="font-family: 'Patrick Hand', cursive !important;">
                  ...
                  <div class="col-span-6 flex justify-center relative">
                    <div class="relative">
                      <div class="w-[110px] md:w-[125px] h-[125px] md:h-[140px] rounded-[16px] overflow-hidden shadow-md border-2 border-white bg-white">
                ...
                <!-- 3. Tech I Work With -->
                <div class="border border-dashed border-amber-900/30 rounded-xl p-2.5 bg-[#F8F3EA]">
                  <span class="text-xs text-[#6B2137] font-bold block mb-1.5" style="font-family: 'Patrick Hand', cursive !important;">tech i work with ヾ</span>
                  
                  <div class="grid grid-cols-7 gap-1 items-center text-center text-[9px] font-medium text-gray-700">
                ...
                <!-- 4. What I Build Box -->
                <div class="grid grid-cols-12 gap-2.5 items-center">
                  <div class="col-span-9 border border-dashed border-amber-900/30 rounded-xl p-2.5 bg-[#F8F3EA]">
                    ...
                    <div class="grid grid-cols-3 gap-1.5 text-center text-[9.5px] font-bold text-gray-800" style="font-family: 'Patrick Hand', cursive !important;">
                      <div class="p-1.5 bg-white/80 rounded-lg border border-amber-900/10 flex flex-col items-center justify-center">
                  ...
                  <div class="col-span-3 bg-[#EFE5D8] p-2 rounded-lg border border-amber-900/15 text-center relative shadow-sm h-full flex flex-col items-center justify-center">
    ...
    spread1_pattern = r'<!-- INNER PAGES SPREAD 1 \(PAGES 01 & 02 - EXACT 100% REPLICATION OF USER REFERENCE\) -->[\s\S]*?(?=<!-- INNER PAGES SPREAD 2)'
    ...
    with open('e:/portfoliosite/index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("SUCCESSFULLY ALIGNED SPREAD 1 WITH ZERO WHITESPACE GAPS!")
else:
