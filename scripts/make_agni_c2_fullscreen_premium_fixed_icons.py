...
<head>
  ...
  <style>
    ...
    /* Crucial: Preserve FontAwesome font family so icons render 100% crisply without broken squares */
...
<body class="antialiased selection:bg-[#8b2252] selection:text-white">
  ...
  <!-- Top Fullwidth Sticky Navigation Bar -->
  <nav class="w-full py-5 px-6 md:px-12 lg:px-16 flex justify-between items-center max-w-7xl mx-auto border-b border-amber-900/10 sticky top-0 bg-[#FAF8F5]/95 backdrop-blur-md relative z-50">
    <a href="index.html#projects" class="text-gray-900 font-semibold text-sm flex items-center gap-2.5 hover:text-[#8b2252] transition-colors">
      <svg class="w-4 h-4 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
      <span>Back to Portfolio</span>
    </a>
    
    <div class="flex items-center gap-3">
      <!-- Mail Me for Technical Report PDF -->
      <a href="mailto:srishakthi799@gmail.com?subject=AGNI%20C2%20Technical%20Report%20PDF%20Request&body=Hi%20Shakthi%20Sri,%0A%0AI%20would%20like%20to%20request%20the%20full%20AGNI%20C2%20136-page%20Technical%20Report%20PDF...%0A%0AName:%20%0AOrganization/Role:%20" class="px-4 py-2.5 bg-rose-50 hover:bg-rose-100 text-rose-800 border border-rose-200 rounded-xl text-xs font-bold flex items-center gap-2 transition-all hover:scale-105 shadow-xs">
        <svg class="w-4 h-4 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V7.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 1H7a2 2 0 00-2 2v16a2 2 0 002 2z"></path></svg>
        <span>Request Report PDF</span>
      </a>
      
      <!-- Mail Me for GitHub Repo Access -->
      <a href="mailto:srishakthi799@gmail.com?subject=AGNI%20C2%20Repository%20Access%20Request&body=Hi%20Shakthi%20Sri,%0A%0AI%20am%20interested%20in%20requesting%20access%20to%20the%20AGNI%20C2%20GitHub%20repository...%0A%0AName:%20%0AOrganization/Role:%20" class="px-4 py-2.5 bg-[#8b2252] hover:bg-[#721b42] text-white rounded-xl text-xs font-bold flex items-center gap-2 transition-all hover:scale-105 shadow-sm">
        <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.53 1.032 1.53 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z"/></svg>
  ...
  <header class="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 pt-16 pb-12 gs-reveal">
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center border-b border-amber-900/10 pb-12 gap-8">
      <div class="space-y-4 max-w-4xl">
        <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#8b2252]/10 text-[#8b2252] text-xs font-bold rounded-full border border-[#8b2252]/20">
          <svg class="w-4 h-4 text-[#8b2252]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
          <span>PUBLISHED RESEARCH PAPER • ICTACA'26</span>
        </div>

        <h1 class="text-3xl md:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 leading-tight">
          AGNI C2: Cognitive Command &amp; Control For Red Teaming And Cybersecurity Education
        </h1>

        <div class="pt-2 flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
      ...
      <div class="lg:text-right space-y-2 border-l-2 lg:border-l-0 border-[#8b2252]/20 pl-4 lg:pl-0 shrink-0">
        <p class="text-xs font-bold text-gray-900">Anna University: Chennai 600 025</p>
    ...
    <!-- Keywords Tag Bar -->
    <div class="flex flex-wrap items-center gap-2.5 pt-6">
      <span class="text-xs font-bold text-gray-400 uppercase tracking-wider mr-2">KEYWORDS:</span>
  ...
  <!-- Fullscreen Abstract Card & Restricted Access Banner -->
  <section class="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 mb-20 space-y-8 gs-reveal">
    <div class="neat-card p-8 md:p-12 border-t-4 border-t-[#8b2252] space-y-6">
      <div class="flex items-center gap-2 text-xs font-bold text-[#8b2252] uppercase tracking-widest">
        <svg class="w-4 h-4 text-[#8b2252]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
        <span>RESEARCH ABSTRACT</span>
      </div>
      
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 text-base text-gray-800 leading-relaxed font-normal">
        <p>
    ...
    <div class="bg-gradient-to-r from-purple-50 via-rose-50 to-purple-50 border border-[#8b2252]/20 rounded-3xl p-8 md:p-10 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xs">
      <div class="space-y-2 text-left">
        <div class="flex items-center gap-2 text-[#8b2252] text-xs font-bold uppercase tracking-wider">
          <svg class="w-4 h-4 text-[#8b2252]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
  ...
  <!-- Fullwidth Main Content Structure -->
  <main class="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 mb-28 space-y-24">
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="neat-card p-6 md:p-10 overflow-hidden bg-white text-center shadow-xs">
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="neat-card p-8 md:p-12 space-y-8 text-sm text-gray-700 leading-relaxed">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="space-y-3">
            <h3 class="text-base font-bold text-gray-900 flex items-center gap-2">
              <svg class="w-5 h-5 text-[#8b2252]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
          ...
          <div class="space-y-3">
            <h3 class="text-base font-bold text-gray-900 flex items-center gap-2">
              <svg class="w-5 h-5 text-[#8b2252]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        ...
        <div class="pt-6 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div class="space-y-3">
            <h3 class="text-base font-bold text-gray-900 flex items-center gap-2">
              <svg class="w-5 h-5 text-[#8b2252]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"></path></svg>
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="neat-card p-8 md:p-12 space-y-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
          <div class="p-6 bg-gray-50 rounded-2xl border border-gray-200/70 space-y-2">
          ...
          <div class="p-6 bg-purple-50 rounded-2xl border border-[#8b2252]/30 space-y-2">
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- 3 Problems -->
        <div class="neat-card p-8 md:p-10 space-y-5 border-l-4 border-l-rose-600">
        ...
        <!-- 4 Objectives -->
        <div class="neat-card p-8 md:p-10 space-y-5 border-l-4 border-l-[#8b2252]">
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="neat-card p-6 md:p-10 overflow-hidden bg-white shadow-xs space-y-4">
    ...
    <section class="gs-reveal space-y-12">
      <div class="flex items-center gap-3">
        <span class="w-6 h-1 bg-[#8b2252] rounded-full"></span>
      ...
      <!-- Dashboard UI -->
      <div class="neat-card p-8 space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
        ...
        <div class="neat-card p-6 space-y-3 border-t-4 border-t-rose-600 flex flex-col justify-between">
          ...
          <a href="mailto:srishakthi799@gmail.com?subject=AGNI%20C2%20Technical%20Report%20PDF%20Request" class="mt-3 inline-flex items-center gap-1.5 font-bold text-rose-700 hover:underline">
            ...
            <svg class="w-3.5 h-3.5 text-rose-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
          </a>
        </div>
      </div>
    </section>
    ...
    <section class="gs-reveal space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-xs">
        <div class="p-6 bg-white rounded-2xl border border-gray-200/80 shadow-xs space-y-2">
  ...
  <footer class="bg-white py-16 border-t border-gray-200 relative z-20">
    <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 text-center space-y-8">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        ...
        <a href="mailto:srishakthi799@gmail.com?subject=AGNI%20C2%20Technical%20Report%20PDF%20Request" class="px-6 py-3.5 bg-rose-50 border border-rose-200 hover:border-rose-300 text-rose-800 rounded-xl font-bold text-xs flex items-center gap-2 transition-all hover:scale-105 shadow-xs">
          <svg class="w-4 h-4 text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
