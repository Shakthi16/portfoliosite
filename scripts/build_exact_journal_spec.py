...
# -------------------------------------------------------------
# EXACT JOURNAL SPECIFICATION (COVER, SPREAD 1-2, SPREAD 3-4)
# -------------------------------------------------------------
...
<section class="relative bg-[#f4efe6] text-[#1F1F1F] py-20 overflow-hidden border-b border-amber-900/10 z-20" id="about-journal">
  <div class="max-w-6xl mx-auto px-4 md:px-8 text-center">
    ...
    <div class="relative w-full max-w-[980px] mx-auto min-h-[620px] flex items-center justify-center perspective-1000">
      ...
      <div id="jbook-cover" class="cursor-pointer transition-all duration-700 ease-out transform scale-100 opacity-100 flex flex-col items-center z-30" onclick="flipJournalBook('spread1')">
        <div class="relative group">
          ...
          <div class="w-[320px] md:w-[420px] h-[540px] rounded-[28px] shadow-[0_30px_70px_-15px_rgba(0,0,0,0.3)] overflow-hidden relative bg-[#36132b] border border-amber-900/30 transition-transform duration-500 hover:scale-[1.02] hover:-rotate-1">
            ...
            <!-- Hover Touch Hint -->
            <div class="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-2">
      ...
      <!-- ==================== VIEW 2: OPENED SPREAD 1 (PAGES 1 & 2 - MATCHING IMAGE 1) ==================== -->
      ...
      <div id="jbook-spread2" class="hidden transition-all duration-700 ease-out transform opacity-0 scale-95 w-full z-30">
        ...
        <div class="w-full bg-[#faf6ee] rounded-[32px] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.22)] border border-amber-900/15 p-6 md:p-10 relative overflow-hidden text-left" style="background-image: radial-gradient(#d6cebe 1px, transparent 1px); background-size: 20px 20px;">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 relative z-10 pt-2">
            ...
            <!-- PAGE 4: ENGINEERING PRINCIPLES (EXACT TEXT) -->
            <div class="space-y-4 text-left">
              <div>
              ...
              <div class="space-y-2 text-[11px] text-gray-700">
                ...
                <div class="p-2.5 rounded-xl bg-white/80 border border-amber-900/10">
                  ...
                  <p class="text-gray-600 leading-relaxed">Technology should create measurable value. Features should solve meaningful problems. Purpose gives direction to innovation.</p>
                </div>
                ...
                <div class="p-2.5 rounded-xl bg-white/80 border border-amber-900/10">
                  ...
                  <p class="text-gray-600 leading-relaxed">Behind every interface is a person trying to accomplish something. Thoughtful design reduces confusion and respects attention.</p>
                </div>

                <div class="p-2.5 rounded-xl bg-white/80 border border-amber-900/10">
                  <h4 class="font-bold text-xs text-[#421835]">Principle 04 — Document Everything That Matters</h4>
                  <p class="text-gray-600 leading-relaxed">Clear documentation preserves context, supports collaboration, and ensures ideas remain useful long after implementation.</p>
                </div>

                <div class="p-2.5 rounded-xl bg-white/80 border border-amber-900/10">
                  <h4 class="font-bold text-xs text-[#421835]">Principle 05 — Progress Through Iteration</h4>
                  <p class="text-gray-600 leading-relaxed">Perfection is rarely achieved in version 1. Meaningful improvement comes through observation, feedback, and refinement.</p>
                </div>
              ...
              <div class="pt-2 border-t border-dashed border-amber-900/20 flex justify-between items-center text-[10px] font-serif italic text-gray-600">
                ...
                <span class="font-bold text-[#8b2252]">"Technology changes. Principles endure."</span>
              </div>
...
content = re.sub(r'<!-- ABOUT ME: OPENED PERSONAL JOURNAL SPREAD.*?<!-- /section -->', EXACT_JOURNAL_HTML, content, flags=re.DOTALL)
content = re.sub(r'<!-- ABOUT ME: CREATIVE 3D INTERACTIVE JOURNAL BOOK.*?<!-- Smooth Page Flip Script -->', EXACT_JOURNAL_HTML, content, flags=re.DOTALL)
content = re.sub(r'<!-- ABOUT ME: EXACT SPECIFICATION 4-PAGE JOURNAL BOOK.*?<!-- Smooth Page Flip Script -->', EXACT_JOURNAL_HTML, content, flags=re.DOTALL)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(content)

print("Successfully updated Journal Book to exact 4-page specification with cover.png!")
