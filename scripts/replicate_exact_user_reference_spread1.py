...
if start_pos != -1 and end_pos != -1:
    ...
    clean_style = """<style>
      #about-journal .font-journal-display {
        font-family: 'Outfit', sans-serif !important;
      }
      #about-journal .font-journal-hand {
        font-family: 'Patrick Hand', cursive !important;
        font-weight: 500 !important;
      }
      #about-journal .font-journal-mono {
    ...
    new_spread1 = '''          <!-- INNER PAGES SPREAD 1 (100% EXACT REPLICATION OF USER REFERENCE) -->
          <div id="smriti-spread-1" class="w-full bg-[#FAF6EE] rounded-[18px] p-4 md:p-5 relative overflow-hidden text-left min-h-[520px] md:min-h-[550px] h-[520px] md:h-[550px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <!-- PAGE 01: LEFT SIDE -->
              <div class="flex flex-col justify-between space-y-1.5 text-left pr-0 md:pr-2 h-full">
                <!-- 1. Header & Sub-header -->
                <div>
                  <h3 class="text-3xl md:text-[38px] font-extrabold text-[#1C1917] mb-1 tracking-tight leading-none font-journal-display">Shakthi Sri</h3>
                  <div class="flex flex-wrap items-center gap-2 mb-1">
                    <span class="px-2.5 py-0.5 bg-[#E8D5CE] text-[#6B2137] text-[10px] font-bold rounded-full border border-[#D9BEB4] tracking-wider uppercase font-journal-display">DEVELOPER &amp; RESEARCHER</span>
                    <span class="text-xs text-[#2C2C2C] font-semibold underline underline-offset-4 decoration-[#6B2137]/30 font-journal-hand">class of 2026</span>
                  </div>
                </div>

                <!-- 2. Timeline List with Icons -->
                <div class="space-y-1 text-xs text-[#2C2C2C] font-medium font-journal-hand">
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-0.5">
                    ...
                    <span class="text-gray-600 font-journal-mono text-[11px]">2022 - 2026</span>
                  </div>
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-0.5">
                    ...
                    <span class="text-[#6B2137] font-bold font-journal-mono text-[11px]">CGPA: 8.6</span>
                  </div>
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-0.5">
                    ...
                    <span class="text-gray-600 font-journal-hand text-[11px]">Research Intern</span>
                  </div>
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-0.5">
                    ...
                    <span class="text-gray-600 font-journal-mono text-[11px]">MERN Stack</span>
                  </div>
                  ...
                  <div class="flex justify-between items-center border-b border-dashed border-amber-900/20 pb-0.5">
                    ...
                    <span class="text-gray-600 font-journal-hand text-[11px]">Always Learning</span>
                  </div>
                </div>

                <!-- 3. Taped Cards Row -->
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-1 font-journal-hand">
                  ...
                  <div class="bg-[#F6EFE6] p-2.5 rounded-xl border border-amber-900/15 shadow-2xs relative">
                    ...
                    <span class="text-xs text-[#6B2137] font-bold block mb-0.5">about me ヾ</span>
                    <ul class="text-[13.5px] text-[#2C2C2C] font-medium leading-tight space-y-0.5">
                  ...
                  <!-- TODAY Box -->
                  <div class="bg-[#F6EFE6] p-2.5 rounded-xl border border-amber-900/15 shadow-2xs relative">
                    <div class="flex items-center justify-between mb-0.5 font-journal-display">
                    ...
                    <span class="text-[8.5px] font-journal-mono font-bold text-gray-500 uppercase block mb-0.5">TODAY</span>
                    <p class="text-[13.5px] text-[#2C2C2C] font-medium leading-tight font-journal-hand">
                ...
                <div class="pt-1 border-t border-dashed border-amber-900/20 flex justify-between items-center gap-2">
                  <div class="bg-[#EFE5D8] px-2.5 py-1.5 rounded-lg text-[11.5px] text-[#2C2C2C] font-medium border border-amber-900/15 font-journal-hand shadow-2xs">
                  ...
                  <div class="text-right font-journal-hand">
                    <span class="text-xs text-[#6B2137] font-bold">“</span>
                    <p class="text-sm md:text-base text-[#541C2E] font-bold leading-tight inline-block">code with purpose,<br/>create with impact. ♡</p>
              ...
              <!-- PAGE 02: RIGHT SIDE -->
              <div class="flex flex-col justify-between space-y-1.5 text-left pl-0 md:pl-2 h-full">
                <!-- 1. Top Row: Icons -->
                <div class="flex justify-between items-start font-journal-hand">
                  <div class="text-center">
                    ...
                    <span class="block text-[10px] text-gray-700 mt-0.5">breathe.png</span>
                  </div>
                ...
                <div class="grid grid-cols-12 gap-2 items-center">
                  <!-- currently ヾ -->
                  <div class="col-span-6 border border-dashed border-amber-900/30 rounded-xl p-2.5 bg-[#F8F3EA] font-journal-hand">
                    <span class="text-xs text-[#6B2137] font-bold block mb-0.5">currently ヾ</span>
                    <ul class="text-[13px] text-[#2C2C2C] font-medium leading-tight space-y-0.5">
                  ...
                  <!-- Character Illustration (Standing Girl) -->
                  <div class="col-span-6 flex justify-center relative">
                    <div class="relative">
                      <div class="w-[110px] md:w-[130px] h-[140px] md:h-[160px] overflow-hidden flex items-center justify-center">
                        <img src="girl.png" alt="Shakthi Sri Illustration" class="w-full h-full object-contain filter drop-shadow-md"/>
                      </div>
                      <div class="absolute -top-1 right-0 bg-[#1A1A1A] text-white font-journal-mono text-[7.5px] font-bold px-2 py-0.5 rounded-full shadow-md z-30">
                        @Shakthi.16
                      </div>
                    </div>
                  </div>
                ...
                <div class="border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA]">
                  <span class="text-xs text-[#6B2137] font-bold block mb-1 font-journal-hand">tech i work with ヾ</span>
                  
                  <div class="grid grid-cols-7 gap-1 items-center text-center text-[9px] font-medium text-gray-700 font-journal-display">
                ...
                <!-- 4. What I Build Box -->
                <div class="grid grid-cols-12 gap-2 items-center font-journal-hand">
                  <div class="col-span-9 border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA]">
                    <span class="text-xs text-[#6B2137] font-bold block mb-0.5 text-center">what i build ♡</span>
                    <div class="grid grid-cols-3 gap-1 text-center text-[9.5px] font-bold text-gray-800 font-journal-display">
    ...
    with open('e:/portfoliosite/index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("SUCCESSFULLY REPLICATED EXACT USER REFERENCE LAYOUT 1:1!")
else:
