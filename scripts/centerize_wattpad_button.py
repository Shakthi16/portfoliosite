...
if start_pos != -1:
    ...
    # Perfectly centerized position: a little left and a little up
    new_button = '''<!-- WATTPAD INTERACTIVE LINK BUTTON EMBEDDED PERFECTLY ON DOTTED PLACEHOLDER LINE -->
            <a href="https://www.wattpad.com/story/411657344-the-threadweaver's-knot" target="_blank" rel="noopener noreferrer" 
               class="absolute bottom-[28px] md:bottom-[34px] right-[118px] md:right-[165px] z-40 bg-[#4A1224] hover:bg-[#6B2137] text-white font-bold text-[9.5px] sm:text-[10.5px] px-2.5 sm:px-3.5 py-0.5 sm:py-1 rounded-full shadow-md transition-all hover:scale-105 flex items-center gap-1 border border-amber-200/40 group">
    ...
    with open('e:/portfoliosite/index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("SUCCESSFULLY CENTERIZED WATTPAD BUTTON (LITTLE LEFT AND LITTLE UP)!")
else:
