...
new_home = """<section id="home" style="position: relative; overflow: hidden; height: 100vh; min-height: 700px; width: 100vw; background-color: #fdfaf8; background-image: linear-gradient(#f0e9e4 1px, transparent 1px), linear-gradient(90deg, #f0e9e4 1px, transparent 1px); background-size: 50px 50px;">
  ...
  <div class="floating-sticker" style="top: 2%; right: 12%; z-index: 8; transform: rotate(-2deg); scale: 0.85;">
    ...
    <!-- FIXED ALIGNMENT: 110px left padding strictly forces text onto the grid squares! -->
    <div style="width: 290px; height: 290px; background: url('notes.png') center/contain no-repeat; padding: 60px 40px 30px 110px; box-sizing: border-box; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.05)); display: flex; flex-direction: column;">
      <div style="font-family: 'Brittany Signature', cursive !important; font-size: 26px; color: #421835; margin-bottom: 8px; text-align: left; text-shadow: 0 1px 2px rgba(255,255,255,0.5);">what drives me</div>
      <div style="font-size: 10px; color: #582a4b; font-family: 'Manrope', sans-serif !important; line-height: 2.2; text-align: left; padding-right: 10px;">
      ...
      <div style="text-align: right; margin-top: 5px; font-size: 14px; color: #a4768f; padding-right: 15px;">♡</div>
    </div>
  </div>
  ...
  <div class="floating-sticker" style="top: 45%; left: 18%; z-index: 7; transform: rotate(2deg); scale: 0.85;">
    <!-- FIXED ALIGNMENT: Shifted text to correctly align inside the crumpled paper borders -->
    <div style="width: 270px; height: 270px; background: url('notes1.png') center/contain no-repeat; padding: 50px 30px 40px 80px; box-sizing: border-box; filter: drop-shadow(0 10px 15px rgba(0,0,0,0.05)); display: flex; flex-direction: column;">
      <div style="font-family: 'IBM Plex Mono', monospace !important; font-size: 9px; font-weight: 600; color: #7a3a5e; letter-spacing: 0.1em; line-height: 1.4; margin-bottom: 15px; text-align: left; max-width: 150px;">LESSONS I'M STILL<br>LEARNING</div>
      <ul style="list-style: none; padding: 0; margin: 0; font-size: 10px; color: #582a4b; font-family: 'Manrope', sans-serif !important; line-height: 1.8; text-align: left; max-width: 150px;">
  ...
  <div class="floating-sticker" style="bottom: 8%; right: 28%; z-index: 10; transform: rotate(2deg); transform-origin: bottom right; scale: 0.85;">
    ...
    <div style="width: 170px; padding: 25px 20px; background: #fff; border-radius: 12px; box-shadow: 0 15px 35px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.02);">
      ...
      <!-- PERFECTLY ALIGNED GRID WITH 3D SHADOWS ON ICONS -->
...
print("Home section rewritten to perfectly align texts and apply 3D drop-shadows to the Tech Stack grid.")
