...
new_home = """<section id="home" style="position: relative; overflow: hidden; height: 100vh; min-height: 800px; width: 100vw; background-color: #fdfaf8; background-image: linear-gradient(#f0e9e4 1px, transparent 1px), linear-gradient(90deg, #f0e9e4 1px, transparent 1px); background-size: 50px 50px;">
  ...
  <!-- CENTER TITLE (More breathing room!) -->
  <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; z-index: 1; width: 100%;">
    <!-- Using inline !important to beat the global Inter override -->
    <h1 style="font-family: 'Alex Brush', cursive !important; font-size: clamp(80px, 9vw, 130px); font-weight: 400; color: #421835; margin: 0; line-height: 1;">Shakthi Sri</h1>
    <div style="font-family: 'Manrope', sans-serif !important; font-size: clamp(10px, 1.2vw, 14px); font-weight: 700; letter-spacing: 0.5em; text-transform: uppercase; color: #582a4b; margin-top: 25px;">DESIGN &bull; SECURE &bull; EMPOWER</div>
    <div style="font-family: 'IBM Plex Mono', monospace !important; font-size: 11px; color: #7a3a5e; margin-top: 15px; letter-spacing: 0.05em; line-height: 1.6;">Crafting intuitive experiences.<br>Securing what matters.</div>
  </div>

  <!-- 1. ID CARD (Top Left, pushed out further) -->
  <div class="floating-sticker" style="top: -2%; left: 2%; z-index: 10; transform: rotate(-5deg);">
    ...
    <div style="width: 210px; height: 320px; border-radius: 12px; padding: 25px 20px; display: flex; flex-direction: column; align-items: center; text-align: center; background: linear-gradient(135deg, #4b1a37, #2d1023); box-shadow: 0 15px 35px rgba(0,0,0,0.15); border: 1px solid rgba(255,255,255,0.1); margin-top: 20px;">
  ...
  <!-- 2. Desk Setup Image (Top Left, pushed lower left) -->
  <div class="floating-sticker" style="top: 18%; left: 15%; z-index: 7; transform: rotate(2deg);">
    ...
    <div class="polaroid-collage" style="width: 200px; padding: 10px 10px 24px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08);">
      <div style="width: 180px; height: 140px; overflow: hidden; background: #ddd;">
        <!-- Fixed Unsplash source -->
      ...
      <div style="position: absolute; bottom: 20%; left: 15%; width: 50px; height: 50px; background: url('https://images.unsplash.com/photo-1509042239860-f550ce710b93?q=80&w=100') center/cover; border-radius: 50%; border: 2px solid #fff; box-shadow: 0 4px 6px rgba(0,0,0,0.2);"></div>
    </div>
  </div>

  <!-- 3. "Today's focus" Note (Pushed left away from center) -->
  <div class="floating-sticker" style="top: 15%; left: 28%; z-index: 8; transform: rotate(-3deg);">
    ...
    <div class="torn-paper" style="width: 150px; padding: 25px 20px; background: #fff; box-shadow: 0 8px 15px rgba(0,0,0,0.05); border: 1px solid rgba(0,0,0,0.02); clip-path: polygon(0 0, 100% 0, 98% 100%, 0% 98%);">
      <div style="font-family: 'Alex Brush', cursive !important; font-size: 20px; color: #421835; text-align: center; margin-bottom: 15px;">today's focus</div>
      ...
      <div style="position: absolute; bottom: 15px; right: 15px; font-size: 14px; color: #a4768f; font-family: 'Cormorant Garamond', serif !important;">♡</div>
    </div>
  </div>

  <!-- 4. Design Journey Ticket (Top Right, pushed out) -->
  <div class="floating-sticker" style="top: 8%; right: 28%; z-index: 8; transform: rotate(1deg);">
    ...
    <div class="ticket-pass" style="width: 300px; padding: 0; background: #fffafb; display: flex; box-shadow: 0 12px 30px rgba(0,0,0,0.06); border: 1px solid rgba(0,0,0,0.03); border-radius: 6px; overflow: hidden;">
      <div style="background: #a4768f; color: #fff; width: 35px; display: flex; align-items: center; justify-content: center; writing-mode: vertical-rl; transform: rotate(180deg); font-size: 9px; font-family: 'IBM Plex Mono', monospace !important; letter-spacing: 0.2em; padding: 15px 0;">
        all in progress
      </div>
      <div style="padding: 15px 20px; flex: 1;">
        ...
        <div style="margin-top: 15px; font-size: 8px; font-family: 'IBM Plex Mono', monospace !important; color: #7a3a5e; background: #f5ebf0; display: inline-block; padding: 5px 10px; border-radius: 12px; font-weight: 600; letter-spacing: 0.05em;">EST. 2022 - PRESENT &nbsp; +</div>
      </div>
  ...
  <!-- 5. What Drives Me Note (Far Top Right) -->
  <div class="floating-sticker" style="top: 5%; right: 5%; z-index: 7; transform: rotate(-2deg);">
    <div style="width: 220px; padding: 25px; background: #fdfaf8; box-shadow: 0 8px 20px rgba(0,0,0,0.06); border: 1px solid rgba(0,0,0,0.04); clip-path: polygon(2% 0, 100% 2%, 98% 100%, 0% 98%);">
      <div style="font-family: 'Alex Brush', cursive !important; font-size: 24px; color: #421835; margin-bottom: 15px;">what drives me</div>
      <div style="font-size: 13px; color: #582a4b; font-family: 'Manrope', sans-serif !important; line-height: 1.8;">
  ...
  <!-- 6. Pink Flower Branch (Far Top Right Corner) -->
  <div class="floating-sticker" style="top: 2%; right: -2%; z-index: 10; transform: rotate(15deg);">
    ...
    <img src="https://images.unsplash.com/photo-1579244033284-9a84a6fb7b3c?w=300&q=80" alt="Flowers" style="width: 160px; filter: contrast(1.1) brightness(1.1) sepia(0.2) hue-rotate(-20deg); mix-blend-mode: multiply; pointer-events: none;" />
  </div>

  <!-- 7. "currently building" Pink Note (Mid Far Left) -->
  <div class="floating-sticker" style="top: 50%; left: 2%; z-index: 9; transform: rotate(-4deg);">
    <div style="position: absolute; top: 20px; right: 15px; font-size: 24px; color: #7a3a5e; opacity: 0.5; transform: rotate(15deg);">📎</div>
    <div style="width: 180px; padding: 25px; background: #ebd5e0; box-shadow: 0 8px 20px rgba(0,0,0,0.06); clip-path: polygon(0% 2%, 98% 0%, 100% 98%, 2% 100%);">
      <div style="font-family: 'Cormorant Garamond', serif !important; font-style: italic; font-size: 18px; font-weight: 600; color: #421835; text-align: center; margin-bottom: 12px;">currently building</div>
      <div style="font-family: 'Manrope', sans-serif !important; font-size: 12px; color: #582a4b; text-align: center; line-height: 1.8;">
        my future<br>
        one prototype,<br>
        one packet,<br>
        one step at a time.
  ...
  <!-- 8. "LESSONS I'M STILL LEARNING" White Note (Mid Left, pushed out) -->
  <div class="floating-sticker" style="top: 45%; left: 18%; z-index: 7; transform: rotate(2deg);">
    ...
    <div style="width: 160px; padding: 30px 20px; background: #fff; box-shadow: 0 8px 15px rgba(0,0,0,0.05); border: 1px solid rgba(0,0,0,0.02);">
      <div style="font-family: 'IBM Plex Mono', monospace !important; font-size: 9px; font-weight: 600; color: #7a3a5e; letter-spacing: 0.1em; line-height: 1.4; margin-bottom: 20px;">LESSONS I'M STILL<br>LEARNING</div>
      <ul style="list-style: none; padding: 0; margin: 0; font-size: 10px; color: #582a4b; font-family: 'Manrope', sans-serif !important; line-height: 2;">
      ...
      <div style="position: absolute; bottom: 15px; right: 15px; font-size: 18px; color: #a4768f; font-family: 'Cormorant Garamond', serif !important;">☾</div>
    </div>
  </div>

  <!-- 9. 3 Polaroids (Far Mid Right, pushed out) -->
  <div class="floating-sticker" style="top: 35%; right: 3%; width: 260px; height: 320px; z-index: 10;">
    <!-- Moon Sky (Top Left) -->
    <div class="polaroid-collage" style="position: absolute; top: 0; left: 0; transform: rotate(-8deg); width: 130px; padding: 8px 8px 25px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08); z-index: 1;">
    ...
    <div class="polaroid-collage" style="position: absolute; top: 10px; right: 0; transform: rotate(12deg); width: 120px; padding: 8px 8px 25px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08); z-index: 2;">
      ...
      <div style="width: 104px; height: 104px; overflow: hidden; background: #ddd;">
        <img src="https://images.unsplash.com/photo-1543788304-c5cb3673f4e2?q=80&w=400" alt="Flowers" style="width: 100%; height: 100%; object-fit: cover;" />
      </div>
    </div>
    <!-- Desk / Candle (Bottom Left) -->
    <div class="polaroid-collage" style="position: absolute; top: 110px; left: 10px; transform: rotate(-3deg); width: 130px; padding: 8px 8px 35px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.1); z-index: 3;">
      <div style="width: 114px; height: 130px; overflow: hidden; background: #ddd;">
        <img src="https://images.unsplash.com/photo-1603503362142-a82f3c3065d0?q=80&w=400" alt="Candle Desk" style="width: 100%; height: 100%; object-fit: cover;" />
      </div>
    </div>
    <!-- Neon Sign (Bottom Right) -->
    <div class="polaroid-collage" style="position: absolute; top: 140px; right: 10px; transform: rotate(5deg); width: 110px; padding: 8px 8px 30px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.1); z-index: 4;">
      <div style="width: 94px; height: 110px; overflow: hidden; background: #111; position: relative;">
        ...
        <div style="position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); color: #e879f9; font-family: 'Alex Brush', cursive !important; font-size: 20px; text-shadow: 0 0 10px #e879f9; white-space: nowrap; text-align: center; line-height: 1;">trust<br>the<br>process</div>
      </div>
    </div>
  </div>

  <!-- 10. Terminal Window (Bottom Left Corner) -->
  <div class="floating-sticker" style="top: 75%; left: 2%; z-index: 10; transform: rotate(-2deg);">
    <div class="terminal-window" style="width: 250px; background: #fff; border-radius: 8px; box-shadow: 0 12px 30px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.05); overflow: hidden;">
  ...
  <div class="floating-sticker" style="top: 75%; left: 22%; z-index: 12; transform: rotate(3deg);">
    ...
    <div style="width: 140px; padding: 25px 20px; background: #4f2940; border-radius: 4px; box-shadow: 0 10px 25px rgba(0,0,0,0.15);">
      ...
      <div style="text-align: right; margin-top: 15px; font-family: 'Alex Brush', cursive !important; font-size: 18px; color: #c49eb3;">
        - Shakthi Sri
      </div>
  ...
  <div class="floating-sticker" style="top: 70%; left: 38%; z-index: 9; transform: rotate(-1deg);">
    <div style="width: 300px; padding: 25px; background: linear-gradient(135deg, #150912, #2d1023); border-radius: 12px; box-shadow: 0 20px 40px rgba(0,0,0,0.2); border: 1px solid rgba(255,255,255,0.05); position: relative; overflow: hidden;">
      ...
      <div style="display: flex; justify-content: space-between;">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-right: 10px;">
          ...
          <div style="font-family: 'Manrope', sans-serif !important; font-size: 14px; font-weight: 700; color: #fb7185; letter-spacing: 0.1em; margin-top: 5px;">AGNI</div>
        </div>
      </div>
      <div style="margin-top: 15px; font-family: 'Manrope', sans-serif !important; font-size: 8px; font-weight: 600; color: #ebd5e0;">Final Year Project</div>
      <div style="font-family: 'Manrope', sans-serif !important; font-size: 8px; color: #a4768f; line-height: 1.4; margin-top: 2px;">Built with purpose.<br>Securing systems.<br>Empowering defense.</div>
    </div>
  </div>

  <!-- 13. Tech Stack Grid (Bottom Right Center) -->
  <div class="floating-sticker" style="top: 68%; right: 28%; z-index: 10; transform: rotate(2deg);">
    <div style="width: 170px; padding: 20px; background: #fff; border-radius: 10px; box-shadow: 0 12px 25px rgba(0,0,0,0.06); border: 1px solid rgba(0,0,0,0.02);">
      <div style="font-family: 'Manrope', sans-serif !important; font-size: 10px; font-weight: 700; color: #7a3a5e; text-transform: uppercase; letter-spacing: 0.1em; text-align: center; margin-bottom: 15px;">TECH STACK</div>
      <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; place-items: center;">
        ...
        <div style="width: 20px; height: 20px; background: #001e36; color: #26a5e4; font-family: 'Manrope', sans-serif !important; font-weight: 800; font-size: 14px; display: flex; align-items: center; justify-content: center; border-radius: 2px;">Ps</div>
        <div style="width: 20px; height: 20px; background: #330000; color: #ff9a00; font-family: 'Manrope', sans-serif !important; font-weight: 800; font-size: 14px; display: flex; align-items: center; justify-content: center; border-radius: 2px;">Ai</div>
        ...
        <div style="width: 20px; height: 20px; background: #f7df1e; color: #000; font-family: 'Manrope', sans-serif !important; font-weight: 800; font-size: 12px; display: flex; align-items: center; justify-content: center; border-radius: 2px;">JS</div>
        ...
        <div style="width: 20px; height: 20px; background: #3178c6; color: #fff; font-family: 'Manrope', sans-serif !important; font-weight: 800; font-size: 12px; display: flex; align-items: center; justify-content: center; border-radius: 2px;">TS</div>
        <div style="width: 35px; height: 20px; color: #000; font-family: 'Manrope', sans-serif !important; font-weight: 800; font-size: 10px; display: flex; align-items: center; justify-content: center;">NEXT.</div>
      </div>
    </div>
  </div>

  <!-- 14. The Interactive Folder Fan-Out! (Bottom Right side) -->
  <div class="floating-sticker" style="top: 75%; right: 18%; z-index: 12; transform: rotate(-3deg);">
      ...
      <div class="master-folder-3d-icon" style="width: 70px; height: 60px;">
        <svg width="70" height="60" viewBox="0 0 120 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <filter id="folder-shadow-filter" x="-10%" y="-10%" width="130%" height="130%">
              <feDropShadow dx="0" dy="6" stdDeviation="5" flood-color="#421835" flood-opacity="0.3" />
            </filter>
          </defs>
          ...
          <path d="M10 32 L10 80 C10 83 13 85 16 85H104 C107 85 110 83 110 80 L110 36 C110 33 107 31 104 31H54 L46 25 H16 C13 25 10 28 10 32Z" fill="url(#folder-front-grad)" filter="url(#folder-shadow-filter)" />
  ...
  <!-- 15. Vinyl Record (Far Bottom Right Edge) -->
  <div class="floating-sticker" style="top: 45%; right: -5%; z-index: 5; transform: rotate(15deg);">
  ...
  <div class="floating-sticker" style="top: 65%; right: 3%; z-index: 15; transform: rotate(-4deg);">
  ...
  <!-- 17. FAR RIGHT: Functional Retro MacPaint Palette -->
  <div class="floating-sticker" style="top: 25%; right: 2%; z-index: 200 !important; transform: rotate(0deg);">
  ...
  <!-- Drawing Canvas overlay for Paint -->
  <canvas id="drawing-canvas" style="position: absolute; inset: 0; z-index: 100; pointer-events: none;"></canvas>

</section>
"""

# I need to find the paint palette CSS from the old index.html. Since it was removed when I overwrote <section id="home">, wait, the CSS was probably in <style id="aesthetic-updates"> or the main <style> tag.
# I will just write the essential paint palette CSS and Interactive Folder CSS in a <style> block and append it before </head>.
new_css = """
<style id="paint-interactive-styles">
  /* ═══ INTERACTIVE FOLDER ═══ */
  .master-folder-container {
    position: relative;
    width: 70px;
    height: 60px;
    cursor: pointer;
  ...
  .master-folder-3d-icon {
    position: relative;
    z-index: 5;
    transition: transform 0.3s ease;
  }
  .master-folder-container:hover .master-folder-3d-icon,
  .master-folder-container:active .master-folder-3d-icon {
    transform: translateY(-5px) scale(1.05);
  }
  .master-folder-container:hover .sub-folder-item,
  .master-folder-container:active .sub-folder-item {
    opacity: 1;
    pointer-events: auto;
  }
  .master-folder-container:hover .sub-folder-item:nth-child(1),
  .master-folder-container:active .sub-folder-item:nth-child(1) {
    transform: translate(-50px, -60px) rotate(-15deg);
  }
  .master-folder-container:hover .sub-folder-item:nth-child(2),
  .master-folder-container:active .sub-folder-item:nth-child(2) {
    transform: translate(0px, -75px) rotate(0deg);
  }
  .master-folder-container:hover .sub-folder-item:nth-child(3),
  .master-folder-container:active .sub-folder-item:nth-child(3) {
    transform: translate(50px, -60px) rotate(15deg);
  }
  ...
  .paint-tool:nth-child(even) { border-right: none; }
  .paint-tool:hover { background: #d4d4d4; }
  .paint-tool.active-tool { background: #000; color: #fff; }
  .paint-colors-grid {
    display: grid;
  ...
  .erase-mode { cursor: url('data:image/svg+xml;utf8,<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="4" width="16" height="16" fill="white" stroke="black" stroke-width="2"/></svg>') 12 12, auto; }
  .draw-mode { cursor: crosshair; }
</style>
"""

script_logic = """
<script id="paint-interactive-logic">
    ...
    if(canvas) {
      ...
      document.querySelectorAll('.paint-tool').forEach(btn => {
        btn.addEventListener('click', function(e) {
          ...
          activeTool = tool;
          document.querySelectorAll('.paint-tool').forEach(b => b.classList.remove('active-tool'));
          this.classList.add('active-tool');
          
          if (tool === 'cursor') canvas.style.pointerEvents = 'none';
          else {
            canvas.style.pointerEvents = 'auto';
            canvas.className = tool === 'eraser' ? 'erase-mode' : 'draw-mode';
          }
        });
      });
...
# 1. Replace the entire <section id="home">
updated_content = re.sub(r'<section id="home".*?</section>', new_home, content, flags=re.DOTALL)

# 2. Inject CSS if not already there
if "paint-interactive-styles" not in updated_content:
    updated_content = updated_content.replace('</head>', new_css + '\n</head>')

# 3. Inject Script if not already there
if "paint-interactive-logic" not in updated_content:
    updated_content = updated_content.replace('</body>', script_logic + '\n</body>')

with open("index.html", "w", encoding="utf-8") as f:
    f.write(updated_content)

print("Home section rewritten with proper spacing, fonts, paint palette, and interactive folder!")
