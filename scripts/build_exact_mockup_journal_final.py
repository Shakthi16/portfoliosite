...
# Load Google Fonts: Great Vibes, Patrick Hand, Caveat, Outfit
FONT_TAG = """<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;600;700&family=Great+Vibes&family=Outfit:wght@400;600;700;800&family=Patrick+Hand&display=swap" rel="stylesheet">"""

if 'Great+Vibes' not in content or 'Patrick+Hand' not in content:
    content = content.replace('</head>', FONT_TAG + '\n</head>')

# -------------------------------------------------------------
# EXACT MOCKUP MATCHING JOURNAL HTML
# -------------------------------------------------------------
EXACT_MOCKUP_JOURNAL_HTML = """<!-- REALISTIC DECKLE-EDGE TORN PAPER SEPARATION DIVIDER (TOP) -->
...
<!-- ABOUT ME: PHYSICAL JOURNAL BOOK (EXACT MOCKUP MATCH) -->
    ...
    <div class="relative w-full max-w-[890px] mx-auto min-h-[520px] md:min-h-[560px] flex items-center justify-center">
      ...
      <div id="smriti-book-opened" class="hidden w-full transition-opacity duration-500 opacity-0 z-30">
        ...
        <div class="relative w-full max-w-[860px] mx-auto rounded-[24px] p-2.5 md:p-3 shadow-[0_25px_70px_rgba(0,0,0,0.3)] border-2 border-[#3D1426] bg-[#3D1426]">
          ...
          <!-- INNER PAGES SPREAD 1 (PAGES 01 & 02 - EXACT MOCKUP MATCH) -->
          <div id="smriti-spread-1" class="w-full bg-[#FAF6EE] rounded-[18px] p-5 md:p-6 relative overflow-hidden text-left h-[495px] md:h-[525px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <!-- PAGE 01: LEFT SIDE (MATCHING MOCKUP IMAGE) -->
              <div class="flex flex-col justify-between text-left pr-0 md:pr-2">
                <div>
                  <!-- Header -->
                  <h3 class="text-3xl md:text-[42px] font-bold text-[#1C1917] mb-1 tracking-tight leading-none" style="font-family: 'Outfit', sans-serif;">Shakthi Sri</h3>
                  
                  <!-- Sub-header Pill & Great Vibes Cursive Handwriting -->
                  ...
                  <div class="space-y-1.5 text-xs text-[#2C2C2C] font-medium mb-3" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-2">
                    ...
                    <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-sm relative">
                      ...
                      <span class="text-base text-[#6B2137] font-bold block mb-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">about me ヾ</span>
                      <ul class="text-[11px] text-[#2C2C2C] leading-tight space-y-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                    ...
                    <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-sm relative">
                      ...
                      <p class="text-[11px] text-[#2C2C2C] leading-tight" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                ...
                <div class="pt-2 border-t border-dashed border-amber-900/20 flex justify-between items-center gap-2">
                  <div class="bg-[#EFE5D8] px-2.5 py-1.5 rounded-lg text-[11px] text-[#2C2C2C] border border-amber-900/15" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
              ...
              <!-- PAGE 02: RIGHT SIDE (MATCHING MOCKUP IMAGE) -->
              <div class="flex flex-col justify-between relative text-left pl-0 md:pl-2">
                ...
                <div class="flex justify-between items-start mb-2">
                  <div class="text-center">
                    ...
                    <span class="block text-[10px] text-gray-700 mt-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">breathe.png</span>
                  </div>
                  <div class="flex items-center gap-5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                    <div class="text-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center mb-2">
                  ...
                  <div class="sm:col-span-6 border border-dashed border-amber-900/30 rounded-xl p-3 bg-[#F8F3EA]">
                    <span class="text-base text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">currently ヾ</span>
                    <ul class="text-[11px] text-[#2C2C2C] leading-tight space-y-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                ...
                <div class="border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA] mb-2">
                  <span class="text-xs text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">tech i work with ヾ</span>
                ...
                <div class="grid grid-cols-12 gap-2 items-center">
                  <div class="col-span-9 border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA]">
                    <span class="text-xs text-[#6B2137] font-bold block mb-1 text-center" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">what i build ♡</span>
                    <div class="grid grid-cols-3 gap-1.5 text-center text-[10px] font-bold text-gray-800" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
              ...
              <div class="flex flex-col justify-between text-left pr-0 md:pr-2">
                <div>
                  <div class="flex items-center gap-2 mb-0.5">
                    ...
                    <h3 class="text-2xl md:text-3xl font-bold text-[#1F1F1F]" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">On Building. ヾ</h3>
                  </div>
                  <p class="text-[11px] text-gray-500 mb-2" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">Journal Entry — 03</p>
                  <p class="text-xs text-[#2C2C2C] leading-tight mb-1.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                  ...
                  <ul class="text-[11px] text-[#2C2C2C] space-y-0.5 mb-2" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 items-center my-1.5">
                  <div class="bg-[#F6EFE6] p-2.5 rounded-xl border border-amber-900/15 shadow-sm text-[11px] text-[#2C2C2C] relative" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1.5 border-t border-dashed border-amber-900/20">
                  <div class="bg-[#F8F3EA] p-2.5 rounded-xl border border-amber-900/15 relative pl-6" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                  ...
                  <div class="text-left text-[11px] text-[#2C2C2C] flex flex-col justify-between" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                    <div>
              ...
              <div class="flex flex-col justify-between text-left pl-0 md:pl-2">
                <div>
                  <div class="flex items-center justify-between mb-1.5">
                    <div>
                      <h3 class="text-2xl md:text-3xl font-bold text-[#1F1F1F]" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">Things I've Learned. ♡</h3>
                  ...
                  <div class="space-y-2 text-[11px] text-[#2C2C2C] mb-2" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                  ...
                  <div class="p-2.5 bg-[#F6EFE6] rounded-xl border border-amber-900/15 text-[11px] text-[#2C2C2C] text-center mb-2 relative shadow-sm" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                ...
                <div class="pt-1.5 border-t border-dashed border-amber-900/20">
                  <h4 class="font-bold text-sm text-[#1F1F1F] mb-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">Working With Others. 👥</h4>
                  <p class="text-[10.5px] text-gray-600 leading-tight mb-1" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                    Some contributions improve communication, simplify decisions, and prevent mistakes.
                  </p>
                  <div class="bg-[#F6EFE6] p-2 rounded-lg border border-amber-900/15 text-[10.5px] text-[#2C2C2C] text-center mb-1" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
                    "The most valuable work is often the work no one notices because everything functions as expected. ♡"
                  </div>
                  <ul class="text-[10.5px] text-[#2C2C2C] space-y-0.5" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
          ...
          <div id="smriti-spread-3" class="hidden w-full bg-[#FAF6EE] rounded-[18px] p-5 md:p-6 relative overflow-hidden text-left h-[495px] md:h-[525px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            ...
            <div class="flex flex-col items-center justify-center h-full text-center p-6">
              ...
              <p class="text-base text-gray-700 max-w-md" style="font-family: 'Patrick Hand', 'Great Vibes', cursive;">
...
if start_pos != -1 and end_pos != -1:
    content = content[:start_pos] + EXACT_MOCKUP_JOURNAL_HTML + '\n\n' + content[end_pos:]
    print("Successfully built exact mockup matching journal pages & Great Vibes font system!")
