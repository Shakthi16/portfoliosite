...
# -------------------------------------------------------------
# PERFECT PROPORTIONAL JOURNAL BOOK (EXACT COVER MATCH & SIZING)
# 1. Closed Cover: 410px wide x 540px high
# 2. Opened Spread: 860px wide max x 540px high (Perfect 2-page spread matching cover height!)
# 3. Fits cleanly inside screen with outside tabs visible and non-overflowing
# -------------------------------------------------------------
PERFECT_SIZED_JOURNAL_HTML = """<!-- REALISTIC DECKLE-EDGE TORN PAPER SEPARATION DIVIDER (TOP) -->
...
<!-- ABOUT ME: PHYSICAL JOURNAL BOOK (PERFECT COVER PROPORTIONS) -->
<section class="relative bg-[#FAF7F2] text-[#1F1F1F] py-6 md:py-10 overflow-hidden border-b border-amber-900/10 z-20" id="about-journal">
  <div class="max-w-6xl mx-auto px-4 md:px-8 text-center">
    ...
    <div class="relative w-full max-w-[880px] mx-auto min-h-[520px] md:min-h-[550px] flex items-center justify-center">
      ...
      <div id="smriti-book-cover" class="cursor-pointer transition-all duration-500 z-40 group" onclick="openSmritiBook()">
        <div class="relative">
          <!-- Cover Book Image (Exact 380px x 520px) -->
          <div class="w-[290px] md:w-[380px] h-[480px] md:h-[520px] rounded-[26px] shadow-[0_25px_65px_-15px_rgba(0,0,0,0.38)] overflow-hidden relative bg-[#3D1426] border-2 border-[#3D1426]/50">
      ...
      <div id="smriti-book-opened" class="hidden w-full transition-opacity duration-500 opacity-0 z-30">
        ...
        <!-- HARDCOVER FRAME: BURGUNDY #3D1426 MARGIN ENCLOSING PAGES (MAX 860px MATCHING 2 COVERS SIDE BY SIDE) -->
        <div class="relative w-full max-w-[850px] mx-auto rounded-[24px] p-2.5 md:p-3 shadow-[0_25px_70px_rgba(0,0,0,0.3)] border-2 border-[#3D1426] bg-[#3D1426]">
          ...
          <div class="absolute top-6 -right-8 md:-right-10 flex flex-col gap-2 z-50">
            ...
            <button id="tab-btn-spread1" onclick="switchSmritiSpread('spread1')" class="px-1.5 md:px-2 py-3.5 bg-[#541C2E] text-white text-[10px] font-bold rounded-r-xl shadow-md border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1" style="writing-mode: vertical-rl; text-orientation: mixed; font-family: 'Outfit', sans-serif;">
              About Me
            </button>

            <!-- Tab 2: Things I Learnt (P. 03-04) -->
            <button id="tab-btn-spread2" onclick="switchSmritiSpread('spread2')" class="px-1.5 md:px-2 py-3.5 bg-[#7A364B] hover:bg-[#541C2E] text-white text-[10px] font-bold rounded-r-xl shadow-md border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1" style="writing-mode: vertical-rl; text-orientation: mixed; font-family: 'Outfit', sans-serif;">
              Things I Learnt
            </button>

            <!-- Tab 3: Story Writing -->
            <button id="tab-btn-spread3" onclick="switchSmritiSpread('spread3')" class="px-1.5 md:px-2 py-3.5 bg-[#A36D7D] hover:bg-[#541C2E] text-white text-[10px] font-bold rounded-r-xl shadow-md border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1 hidden sm:flex" style="writing-mode: vertical-rl; text-orientation: mixed; font-family: 'Outfit', sans-serif;">
              Story Writing
            </button>

          </div>

          <!-- INNER PAGES SPREAD 1 (EXACT COMPACT PROPORTIONS) -->
          <div id="smriti-spread-1" class="w-full bg-[#FAF6EE] rounded-[18px] p-5 md:p-6 relative overflow-hidden text-left h-[490px] md:h-[515px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <div class="flex flex-col justify-between text-left pr-0 md:pr-2">
                <div>
                  <!-- Main Header -->
                  <h3 class="text-3xl md:text-4xl font-bold text-[#1F1F1F] mb-0.5 tracking-tight" style="font-family: 'Outfit', sans-serif;">Shakthi Sri</h3>
                  ...
                  <div class="flex flex-wrap items-center gap-2 mb-3">
                    ...
                    <span class="text-base text-[#2C2C2C] underline underline-offset-2 decoration-amber-900/40" style="font-family: 'Great Vibes', cursive;">class of 2026</span>
                  </div>

                  <!-- Timeline List -->
                  <div class="space-y-2 text-xs text-[#2C2C2C] font-medium mb-3" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-2">
                    ...
                    <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-sm relative">
                      ...
                      <span class="text-base text-[#6B2137] font-bold block mb-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">about me ヾ</span>
                      <ul class="text-[11px] text-[#2C2C2C] leading-tight space-y-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                    ...
                    <div class="bg-[#F6EFE6] p-3 rounded-xl border border-amber-900/15 shadow-sm relative">
                      ...
                      <p class="text-[11px] text-[#2C2C2C] leading-tight" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                ...
                <div class="pt-2 border-t border-dashed border-amber-900/20 flex justify-between items-center gap-2">
                  <div class="bg-[#EFE5D8] px-2.5 py-1.5 rounded-lg text-[11px] text-[#2C2C2C] border border-amber-900/15" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
              ...
              <div class="flex flex-col justify-between relative text-left pl-0 md:pl-2">
                ...
                <div class="flex justify-between items-start mb-2">
                  <div class="text-center">
                    ...
                    <span class="block text-[10px] text-gray-700 mt-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">breathe.png</span>
                  </div>
                  <div class="flex items-center gap-5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                    <div class="text-center">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center mb-2">
                  ...
                  <div class="sm:col-span-6 border border-dashed border-amber-900/30 rounded-xl p-3 bg-[#F8F3EA]">
                    <span class="text-base text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', 'Kalam', cursive;">currently ヾ</span>
                    <ul class="text-[11px] text-[#2C2C2C] leading-tight space-y-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                ...
                <div class="border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA] mb-2">
                  <span class="text-xs text-[#6B2137] font-bold block mb-1" style="font-family: 'Patrick Hand', 'Kalam', cursive;">tech i work with ヾ</span>
                ...
                <div class="grid grid-cols-12 gap-2 items-center">
                  <div class="col-span-9 border border-dashed border-amber-900/30 rounded-xl p-2 bg-[#F8F3EA]">
                    <span class="text-xs text-[#6B2137] font-bold block mb-1 text-center" style="font-family: 'Patrick Hand', 'Kalam', cursive;">what i build ♡</span>
                    <div class="grid grid-cols-3 gap-1.5 text-center text-[10px] font-bold text-gray-800" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
          ...
          <!-- INNER PAGES SPREAD 2 (COMPACT PROPORTIONS) -->
          <div id="smriti-spread-2" class="hidden w-full bg-[#FAF6EE] rounded-[18px] p-5 md:p-6 relative overflow-hidden text-left h-[490px] md:h-[515px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
              ...
              <div class="flex flex-col justify-between text-left pr-0 md:pr-2">
                <div>
                  <div class="flex items-center gap-2 mb-0.5">
                    ...
                    <h3 class="text-2xl md:text-3xl font-bold text-[#1F1F1F]" style="font-family: 'Patrick Hand', 'Kalam', cursive;">On Building. ヾ</h3>
                  </div>
                  <p class="text-[11px] text-gray-500 mb-2" style="font-family: 'Patrick Hand', 'Kalam', cursive;">Journal Entry — 03</p>

                  <p class="text-xs text-[#2C2C2C] leading-tight mb-1.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                  ...
                  <ul class="text-[11px] text-[#2C2C2C] space-y-0.5 mb-2" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 items-center my-1.5">
                  <div class="bg-[#F6EFE6] p-2.5 rounded-xl border border-amber-900/15 shadow-sm text-[11px] text-[#2C2C2C] relative" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1.5 border-t border-dashed border-amber-900/20">
                  <div class="bg-[#F8F3EA] p-2.5 rounded-xl border border-amber-900/15 relative pl-6" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                  ...
                  <div class="text-left text-[11px] text-[#2C2C2C] flex flex-col justify-between" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                    <div>
              ...
              <div class="flex flex-col justify-between text-left pl-0 md:pl-2">
                <div>
                  <div class="flex items-center justify-between mb-1.5">
                    <div>
                      <h3 class="text-2xl md:text-3xl font-bold text-[#1F1F1F]" style="font-family: 'Patrick Hand', 'Kalam', cursive;">Things I've Learned. ♡</h3>
                  ...
                  <div class="space-y-2 text-[11px] text-[#2C2C2C] mb-2" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                  ...
                  <div class="p-2.5 bg-[#F6EFE6] rounded-xl border border-amber-900/15 text-[11px] text-[#2C2C2C] text-center mb-2 relative shadow-sm" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                ...
                <div class="pt-1.5 border-t border-dashed border-amber-900/20">
                  <h4 class="font-bold text-sm text-[#1F1F1F] mb-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">Working With Others. 👥</h4>
                  <p class="text-[10.5px] text-gray-600 leading-tight mb-1" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                    Some contributions improve communication, simplify decisions, and prevent mistakes.
                  </p>

                  <div class="bg-[#F6EFE6] p-2 rounded-lg border border-amber-900/15 text-[10.5px] text-[#2C2C2C] text-center mb-1" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
                    "The most valuable work is often the work no one notices because everything functions as expected. ♡"
                  </div>

                  <ul class="text-[10.5px] text-[#2C2C2C] space-y-0.5" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
          ...
          <div id="smriti-spread-3" class="hidden w-full bg-[#FAF6EE] rounded-[18px] p-5 md:p-6 relative overflow-hidden text-left h-[490px] md:h-[515px] flex flex-col justify-between" style="background-image: radial-gradient(#D8CFC3 1.2px, transparent 1.2px); background-size: 20px 20px;">
            <button onclick="closeSmritiBook()" class="absolute top-3 right-4 text-gray-500 hover:text-[#6B2137] text-lg font-bold z-40 p-1 transition-colors" title="Close Journal">
              ✕
            </button>
            <div class="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[1.5px] bg-amber-900/15 hidden md:block"></div>
            <div class="flex flex-col items-center justify-center h-full text-center p-6">
              ...
              <p class="text-base text-gray-700 max-w-md" style="font-family: 'Patrick Hand', 'Kalam', cursive;">
...
if start_pos != -1 and end_pos != -1:
    content = content[:start_pos] + PERFECT_SIZED_JOURNAL_HTML + '\n\n' + content[end_pos:]
    print("Successfully adjusted journal dimensions to exact proportional hardcover match (max 850px wide x 515px height)!")
