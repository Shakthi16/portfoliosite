...
full_card_projects_grid = '''<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10" id="project-grid">
          <!-- 1. AGNI C2 -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="agni-c2.html" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Cybersecurity</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">AI C2</span>
              </div>
          ...
          <!-- 2. Reality Lag -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://github.com/Shakthi16/realitylagv1" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Deception Security</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Python Engine</span>
              </div>
          ...
          <!-- 3. Syclone -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://syclone.onrender.com" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Web App</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Full-Stack</span>
              </div>
          ...
          <!-- 4. EduGo -->
          <div class="project-card-container group proj-item uiux bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://www.figma.com/proto/823yMjZjFP7NlHpt7Cx6bQ/edugo" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">UI/UX</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">EdTech Platform</span>
              </div>
          ...
          <div class="project-card-container group proj-item uiux bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://www.figma.com/proto/I1ASQY2n71Ny3SHtDbZX3R" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">UI/UX</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">User Onboarding</span>
              </div>
          ...
          <div class="project-card-container group proj-item uiux bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://www.figma.com/proto/0DLbG9VmXQKAGVpXYc1WhG" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">UI/UX</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">E-Commerce</span>
              </div>
          ...
          <div class="project-card-container group proj-item uiux bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">UI/UX</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Fintech</span>
              </div>
              <a href="https://www.figma.com/proto/I1ASQY2n71Ny3SHtDbZX3R" target="_blank" class="w-10 h-10 rounded-full border border-gray-300 bg-white flex items-center justify-center text-gray-800 hover:bg-black hover:border-black hover:text-white transition-all shadow-2xs shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
              </a>
          ...
          <!-- 8. Perfume Design -->
          <div class="project-card-container group proj-item uiux bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://www.figma.com/proto/6Z7eRUtDhLp4pDR8ANijP6" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">UI/UX</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Luxury Brand</span>
              </div>
          ...
          <!-- 9. Weather App -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://weatherappweb1.netlify.app/" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Web Dev</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Weather API</span>
              </div>
          ...
          <!-- 10. Aurum Page -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://aurumpage5.netlify.app/" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Web Dev</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Frontend</span>
              </div>
          ...
          <!-- 11. 3D Cosmic -->
          <div class="project-card-container group proj-item web bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="https://cosmicstar.netlify.app/" target="_blank" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Three.js</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">3D Galaxy</span>
              </div>
          ...
          <div class="project-card-container group proj-item graphic hidden bg-[#f4efe6] rounded-[32px] p-6 border border-black/10 shadow-[0_8px_25px_rgba(0,0,0,0.04)] transition-all duration-500 hover:shadow-[0_16px_35px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex flex-col justify-between space-y-5">
            <a href="startuptn.html" class="block w-full h-[240px] md:h-[260px] rounded-[20px] overflow-hidden bg-white shadow-sm">
            ...
            <div class="flex items-center justify-between gap-2 pt-2 border-t border-black/5">
              <div class="flex flex-wrap items-center gap-2">
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Graphic Design</span>
                <span class="px-3.5 py-1 rounded-full bg-white border border-gray-200/80 text-xs font-semibold text-gray-800 shadow-2xs">Poster</span>
              </div>
...
pattern = r'<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16" id="project-grid">[\s\S]*?</div>\s*</div>\s*</section>'

replacement = full_card_projects_grid + '\n      </div>\n    </section>'
...
if len(updated_html) != len(html):
    ...
    print('SUCCESSFULLY ENCLOSED FULL PROJECT CARDS!')
else:
