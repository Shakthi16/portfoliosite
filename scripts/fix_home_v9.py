...
new_home = """<section id="home" style="position: relative; overflow: hidden; height: 100vh; min-height: 700px; width: 100vw; background-color: #fdfaf8; background-image: linear-gradient(#f0e9e4 1px, transparent 1px), linear-gradient(90deg, #f0e9e4 1px, transparent 1px); background-size: 50px 50px;">
  ...
  <!-- CENTER TITLE (Exactly centered, no pointer events) -->
  ...
  <!-- 1. ID CARD (Top Left, very edge) -->
  <div class="floating-sticker float-item" style="top: -2%; left: 0%; z-index: 10; --rot: -2deg; scale: 0.9;">
  ...
  <!-- 2. Desk Setup Image (Top Left, right of ID Card) -->
  <div class="floating-sticker float-item delay-2" style="top: 2%; left: 14%; z-index: 7; --rot: 2deg; scale: 0.8;">
  ...
  <!-- 3. "currently building" Pink Note (Top Mid-Left, right of desk setup) -->
  <div class="floating-sticker float-item delay-4" style="top: 14%; left: 20%; z-index: 9; --rot: -4deg; scale: 0.85;">
  ...
  <!-- 4. "today's focus" Note (Mid-Left edge) -->
  <div class="floating-sticker float-item delay-1" style="top: 40%; left: 3%; z-index: 8; --rot: -3deg; scale: 0.85;">
  ...
  <!-- 5. Terminal Window (Bottom Left edge) -->
  <div class="floating-sticker float-item delay-2" style="bottom: 12%; left: -2%; z-index: 10; --rot: -2deg; scale: 0.8;">
  ...
  <!-- 6. Dark Quote Note (Bottom Left) -->
  <div class="floating-sticker float-item delay-4" style="bottom: 2%; left: 8%; z-index: 12; --rot: 3deg; scale: 0.85;">
  ...
  <!-- 7. "LESSONS I'M STILL LEARNING" Crumpled Note (Bottom Mid-Left) -->
  <div class="floating-sticker float-item delay-1" style="bottom: 18%; left: 16%; z-index: 7; --rot: 2deg; scale: 0.85;">
  ...
  <!-- 8. AGNI C2 Card (Bottom Center-Left) -->
  <div class="floating-sticker float-item delay-1" style="bottom: 2%; left: 28%; z-index: 9; --rot: -1deg; scale: 0.85;">
  ...
  <!-- 9. MacPaint Palette (Bottom Center) -->
  <div class="floating-sticker float-item delay-2" style="bottom: 5%; left: 50%; z-index: 200 !important; --rot: 0deg; scale: 0.8;">
  ...
  <!-- 10. Tech Stack Grid (Bottom Center-Right) -->
  <div class="floating-sticker float-item delay-3" style="bottom: 3%; right: 30%; z-index: 10; --rot: 2deg; scale: 0.85;">
  ...
  <!-- 11. GIRL.PNG (Resting next to 'Sri' and right above 'EMPOWER') -->
  <div class="floating-sticker float-item delay-2" style="top: 45%; right: 24%; z-index: 10; --rot: 2deg;">
  ...
  <!-- 12. Design Journey Ticket (Top Mid-Right) -->
  <div class="floating-sticker float-item delay-1" style="top: 8%; right: 26%; z-index: 8; --rot: 1deg; scale: 0.85;">
  ...
  <!-- 13. What Drives Me Note (Top Far Right) -->
  ...
  <!-- 14. 3 Polaroids (Mid Far Right) -->
  <div class="floating-sticker float-item delay-3" style="top: 38%; right: 2%; width: 220px; height: 300px; z-index: 10; scale: 0.85; --rot: 0deg;">
    <!-- Purple pins -->
  ...
  <!-- 15. Music Player (Bottom Right, left of vinyl) -->
  <div class="floating-sticker float-item delay-4" style="bottom: 12%; right: 16%; z-index: 25; --rot: -4deg; scale: 0.9;">
  ...
  <!-- 16. Interactive folder (Next to Music Player) -->
  <div class="floating-sticker float-item delay-2" style="bottom: 5%; right: 22%; z-index: 12; --rot: -3deg; scale: 0.6;">
  ...
  <!-- 17. Vinyl Record (Far Bottom Right Edge) -->
  <div class="floating-sticker float-item delay-1" style="bottom: -10%; right: -8%; z-index: 5; --rot: 15deg; scale: 0.9;">
...
print("Perfect 1:1 match with user screenshot achieved.")
