...
# -------------------------------------------------------------
# EXACT 100% REPLICATION OF USER'S ATTACHED IMAGES 1, 2 & 3:
# - Page 01 & 02 (Spread 1): Shakthi Sri, Timeline, Taped About Me, TODAY, Contact Memo, Quote, Breathe doodle, Currently, Photo coat, Tech icons, What I build
# - Page 03 & 04 (Spread 2): On Building. Journal Entry 03, Taped Quote, Bridge sketch, Spiral Note, Reflection, Things I've Learned (4 circle items), Working With Others, Taped Note
# - Vertical Right Tabs: Home, About Me, Things I Learnt, Story Writing
# - Bottom Deckle-Edge Torn Paper Separation (Image 2)
# -------------------------------------------------------------
EXACT_IMAGES_JOURNAL_HTML = """<!-- REALISTIC DECKLE-EDGE TORN PAPER SEPARATION DIVIDER (TOP) -->
<div class="w-full relative z-20 pointer-events-none -mb-1 bg-white">
  <svg class="w-full h-7 md:h-11 text-[#f4efe6] fill-current block" viewBox="0 0 1200 80" preserveAspectRatio="none">
    <path d="M0,0 L0,35 L15,38 L30,32 L45,41 L60,34 L75,39 L90,31 L105,37 L120,33 L135,42 L150,36 L165,40 L180,31 L195,38 L210,33 L225,41 L240,35 L255,39 L270,32 L285,38 L300,34 L315,40 L330,31 L345,39 L360,33 L375,41 L390,35 L405,38 L420,32 L435,40 L465,39 L480,31 L495,38 L510,33 L525,42 L540,36 L555,40 L570,32 L585,39 L600,33 L615,41 L630,35 L645,38 L660,32 L675,40 L690,34 L705,39 L720,31 L735,38 L750,33 L765,42 L780,36 L795,40 L810,32 L825,39 L840,33 L855,41 L870,35 L885,38 L900,32 L915,40 L930,34 L945,39 L960,31 L975,38 L990,33 L1005,42 L1020,36 L1035,40 L1050,32 L1065,39 L1080,33 L1095,41 L1110,35 L1125,38 L1140,32 L1155,40 L1170,34 L1185,39 L1200,31 L1200,80 L0,80 Z"></path>
  </svg>
</div>

<!-- ABOUT ME: PHYSICAL SMRITI RAWAT STYLE JOURNAL BOOK -->
<section class="relative bg-[#f4efe6] text-[#1F1F1F] py-8 md:py-12 overflow-hidden border-b border-amber-900/10 z-20" id="about-journal">
  <div class="max-w-7xl mx-auto px-4 md:px-8 text-center">
    ...
    <div class="relative w-full max-w-[1000px] mx-auto min-h-[530px] md:min-h-[560px] flex items-center justify-center">
      ...
      <div id="smriti-book-cover" class="cursor-pointer transition-all duration-500 z-40 group" onclick="openSmritiBook()">
        <div class="relative">
          <!-- Cover Book Image (SLEEK 2px BORDER, EXACT PROPORTIONS) -->
          <div class="w-[310px] md:w-[410px] h-[510px] md:h-[540px] rounded-[24px] shadow-[0_25px_65px_-15px_rgba(0,0,0,0.32)] overflow-hidden relative bg-[#36132b] border-2 border-[#36132b]/40">
      ...
      <div id="smriti-book-opened" class="hidden w-full transition-opacity duration-500 opacity-0 z-30">
        ...
        <!-- SLEEK BOOK CONTAINER WITH 2px BORDER MATCHING IMAGES EXACTLY -->
        <div class="relative w-full rounded-[26px] shadow-[0_25px_70px_-15px_rgba(0,0,0,0.28)] border-2 border-[#36132b]/80 bg-[#36132b]">
          
          <!-- OUTSIDE RIGHT VERTICAL INDEX TABS (IMAGE 3 EXACT SPEC) -->
          <div class="absolute top-8 -right-9 md:-right-11 flex flex-col gap-2 z-50">
            ...
            <button id="tab-btn-spread1" onclick="switchSmritiSpread('spread1')" class="px-2 md:px-2.5 py-4 bg-[#421835] text-white text-[10px] font-mono font-bold rounded-r-xl shadow-lg border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1" style="writing-mode: vertical-rl; text-orientation: mixed;">
              About Me
            </button>

            <!-- Tab 2: Things I Learnt (P. 03-04) -->
            <button id="tab-btn-spread2" onclick="switchSmritiSpread('spread2')" class="px-2 md:px-2.5 py-4 bg-[#9b6b78] hover:bg-[#421835] text-white text-[10px] font-mono font-bold rounded-r-xl shadow-lg border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1" style="writing-mode: vertical-rl; text-orientation: mixed;">
              Things I Learnt
            </button>

            <!-- Tab 3: Story Writing -->
            <button id="tab-btn-spread3" onclick="switchSmritiSpread('spread3')" class="px-2 md:px-2.5 py-4 bg-[#c2a297] hover:bg-[#421835] text-white text-[10px] font-mono font-bold rounded-r-xl shadow-lg border-t border-r border-b border-amber-900/30 flex items-center justify-center transition-all hover:translate-x-1 hidden sm:flex" style="writing-mode: vertical-rl; text-orientation: mixed;">
              Story Writing
            </button>

          </div>

          <!-- INNER PAGES SPREAD 1 (PAGES 01 & 02 - MATCHING IMAGE 1 EXACTLY) -->
          <div id="smriti-spread-1" class="w-full bg-[#faf6ee] rounded-[24px] p-5 md:p-7 relative overflow-hidden text-left h-[500px] md:h-[530px] flex flex-col justify-between" style="background-image: radial-gradient(#d6cebe 1px, transparent 1px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <!-- PAGE 01: LEFT SIDE (IMAGE 1 EXACT MATCH) -->
              <div class="flex flex-col justify-between text-left pr-0 md:pr-2">
                <div>
                  <h3 class="text-3xl md:text-4xl font-bold font-serif text-[#1F1F1F] mb-1.5 tracking-tight">Shakthi Sri</h3>
                  ...
                  <!-- Timeline List with Icons (IMAGE 1 SPEC) -->
                  <div class="space-y-1.5 font-mono text-[11px] text-gray-700 font-medium mb-3">
                  ...
                  <!-- Taped Cards Row (IMAGE 1 SPEC) -->
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5 mb-2">
                    
                    <!-- Taped Note: about me ヾ -->
                    <div class="bg-[#f7f0e6] p-2.5 rounded-2xl border border-amber-900/15 shadow-sm relative">
                      <div class="absolute -top-2 left-1/2 -translate-x-1/2 w-7 h-3 bg-amber-200/80 rotate-[-2deg] border-l border-r border-white/60"></div>
                      <span class="font-serif italic text-[11px] text-[#8b2252] font-bold block mb-1">about me ヾ</span>
                      <ul class="text-[9.5px] text-gray-700 leading-relaxed font-sans space-y-1">
                    ...
                    <div class="bg-[#f7f0e6] p-2.5 rounded-2xl border border-amber-900/15 shadow-sm relative">
                      <div class="flex items-center justify-between mb-1">
                        ...
                        <span class="text-[9px] text-amber-900">☆</span>
                      </div>
                      <span class="text-[9px] font-mono font-bold text-gray-500 uppercase block mb-0.5">TODAY</span>
                      <p class="text-[9.5px] text-gray-700 font-sans leading-relaxed">
                ...
                <!-- Contact Memo & Quote (IMAGE 1 SPEC) -->
                <div class="pt-1.5 border-t border-dashed border-amber-900/20 flex justify-between items-center gap-2">
                  <div class="bg-[#f0e8dc] px-2.5 py-1.5 rounded-xl text-[9.5px] font-mono text-gray-800 border border-amber-900/15">
                  ...
                  <div class="text-right">
                    <p class="font-serif italic text-xs text-[#421835] font-bold">“ code with purpose,<br/>create with impact. ♡</p>
              ...
              <!-- PAGE 02: RIGHT SIDE (IMAGE 1 EXACT MATCH) -->
              <div class="flex flex-col justify-between relative text-left pl-0 md:pl-2">
                ...
                <div class="flex justify-between items-start mb-2">
                  <div class="text-center">
                    ...
                    <span class="block text-[8px] font-serif italic text-gray-600">breathe.png</span>
                  </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-3 items-center mb-3">
                  ...
                  <!-- currently ヾ -->
                  <div class="sm:col-span-6 border border-dashed border-amber-900/30 rounded-2xl p-2.5 bg-[#fbf7f0]">
                    <span class="font-serif italic text-xs text-[#8b2252] font-bold block mb-1">currently ヾ</span>
                    <ul class="text-[9.5px] text-gray-700 leading-relaxed font-sans space-y-0.5">
                  ...
                  <div class="sm:col-span-6 flex justify-center relative">
                    <div class="relative">
                      <div class="w-[135px] md:w-[155px] h-[165px] md:h-[185px] rounded-[18px] overflow-hidden shadow-md border-4 border-white">
                ...
                <!-- Tech I Work With (IMAGE 1 EXACT BRAND LOGOS) -->
                <div class="border border-dashed border-amber-900/30 rounded-2xl p-2.5 bg-[#fbf7f0] mb-2">
                  <span class="font-serif italic text-[11px] text-[#8b2252] font-bold block mb-1.5">tech i work with ヾ</span>
                ...
                <div class="border border-dashed border-amber-900/30 rounded-2xl p-2 bg-[#fbf7f0] relative">
                  ...
                  <div class="grid grid-cols-3 gap-1.5 text-center text-[8.5px] font-mono text-gray-700 font-bold">
          ...
          <!-- INNER PAGES SPREAD 2 (PAGES 03 & 04 - MATCHING IMAGE 3 EXACTLY) -->
          <div id="smriti-spread-2" class="hidden w-full bg-[#faf6ee] rounded-[24px] p-5 md:p-7 relative overflow-hidden text-left h-[500px] md:h-[530px] flex flex-col justify-between" style="background-image: radial-gradient(#d6cebe 1px, transparent 1px); background-size: 20px 20px;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 relative z-10 h-full overflow-y-auto md:overflow-hidden">
              ...
              <!-- PAGE 03: ON BUILDING. JOURNAL ENTRY 03 (IMAGE 3 MATCH) -->
              <div class="space-y-2 text-left pr-0 md:pr-2 flex flex-col justify-between">
                <div>
                  <div class="flex items-center gap-2 mb-1">
                    ...
                    <div>
                      <h3 class="text-xl md:text-2xl font-bold font-serif text-[#1F1F1F] leading-tight">On Building. ヾ</h3>
                      <p class="text-[9px] font-mono text-gray-500">Journal Entry — 03</p>
                    </div>
                  </div>

                  <p class="text-[9.5px] text-gray-700 leading-relaxed font-sans mb-2">
                  ...
                  <ul class="text-[9px] text-gray-700 space-y-0.5 font-sans mb-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 items-center my-1">
                  <div class="bg-[#f7f0e6] p-2 rounded-xl border border-amber-900/15 text-[8.5px] font-serif italic text-gray-800 relative">
                  ...
                  <div class="text-center">
                    <div class="w-full h-12 bg-amber-900/5 rounded-xl border border-dashed border-amber-900/20 flex items-center justify-center text-[9px] font-serif italic text-gray-500">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1 border-t border-dashed border-amber-900/20">
                  <div class="bg-[#fbf7f0] p-2 rounded-xl border border-amber-900/15 text-[8.5px] font-mono text-gray-700">
                  ...
                  <div class="text-left font-serif text-[9px] text-gray-700 flex flex-col justify-between">
                    <span class="font-bold text-[#421835] block mb-0.5">Reflection</span>
                    <p class="italic text-gray-600 leading-tight">
              ...
              <!-- PAGE 04: THINGS I'VE LEARNED. ♡ (IMAGE 3 MATCH) -->
              <div class="space-y-2 text-left pl-0 md:pl-2 flex flex-col justify-between">
                <div>
                  <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-2">
                      ...
                      <h3 class="text-xl md:text-2xl font-bold font-serif text-[#1F1F1F]">Things I've Learned. ♡</h3>
                    </div>
                  </div>

                  <!-- 4 Circle Icon Items (IMAGE 3 SPEC) -->
                  <div class="space-y-1.5 text-[9px] text-gray-700 font-sans mb-3">
                    <div class="flex items-start gap-2">
                      <div class="w-6 h-6 rounded-full bg-amber-900/10 flex items-center justify-center text-[10px] font-mono font-bold text-[#8b2252] shrink-0 mt-0.5">&lt;/&gt;</div>
                      <div>
                        <h4 class="font-bold text-[#421835] text-[9.5px]">The best code usually disappears.</h4>
                    ...
                    <div class="flex items-start gap-2">
                      <div class="w-6 h-6 rounded-full bg-amber-900/10 flex items-center justify-center text-[10px] font-mono font-bold text-[#8b2252] shrink-0 mt-0.5">🕒</div>
                      <div>
                        <h4 class="font-bold text-[#421835] text-[9.5px]">Speed is temporary.</h4>
                    ...
                    <div class="flex items-start gap-2">
                      <div class="w-6 h-6 rounded-full bg-amber-900/10 flex items-center justify-center text-[10px] font-mono font-bold text-[#8b2252] shrink-0 mt-0.5">📄</div>
                      <div>
                        <h4 class="font-bold text-[#421835] text-[9.5px]">Documentation is an act of respect.</h4>
                    ...
                    <div class="flex items-start gap-2">
                      <div class="w-6 h-6 rounded-full bg-amber-900/10 flex items-center justify-center text-[10px] font-mono font-bold text-[#8b2252] shrink-0 mt-0.5">🌱</div>
                      <div>
                        <h4 class="font-bold text-[#421835] text-[9.5px]">Learning is never finished.</h4>
                  ...
                  <div class="p-2 bg-[#f7f0e6] rounded-xl border border-amber-900/15 text-[8.5px] font-serif italic text-gray-700 text-center mb-2 relative">
                    <div class="absolute -top-2 left-1/2 -translate-x-1/2 w-6 h-2 bg-amber-200/80 rotate-[1deg]"></div>
                ...
                <div class="pt-2 border-t border-dashed border-amber-900/20">
                  <div class="flex items-center justify-between mb-1">
                    <h4 class="font-serif font-bold text-xs text-[#421835]">Working With Others. 👥</h4>
                  </div>

                  <p class="text-[8.5px] text-gray-600 leading-tight mb-1.5">
                  ...
                  <div class="bg-[#f7f0e6] p-1.5 rounded-lg border border-amber-900/15 text-[8px] font-serif italic text-gray-800 text-center mb-1.5">
                    "The most valuable work is often the work no one notices because everything simply functions as expected. ♡"
                  </div>

                  <ul class="text-[8px] text-gray-700 space-y-0.5">
          ...
          <div id="smriti-spread-3" class="hidden w-full bg-[#faf6ee] rounded-[24px] p-5 md:p-7 relative overflow-hidden text-left h-[500px] md:h-[530px] flex flex-col justify-between" style="background-image: radial-gradient(#d6cebe 1px, transparent 1px); background-size: 20px 20px;">
            ...
            <div class="flex flex-col items-center justify-center h-full text-center p-8">
              ...
              <h3 class="text-2xl font-bold font-serif text-[#1F1F1F] mb-2">Story Writing</h3>
              <p class="text-sm text-gray-600 font-mono italic max-w-md">
...
<!-- REALISTIC DECKLE-EDGE TORN PAPER BOTTOM SEPARATION DIVIDER (IMAGE 2 MATCH) -->
...
# Find start of top deckle divider or section
...
if start_pos != -1 and end_pos != -1:
    content = content[:start_pos] + EXACT_IMAGES_JOURNAL_HTML + '\n\n' + content[end_pos:]
    print("Successfully updated with 100% exact replica of user attached Images 1, 2 & 3!")
