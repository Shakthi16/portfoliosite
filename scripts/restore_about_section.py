...
# Replace the entire #about section content from <section ... id="about" ...> to </section>

NEW_ABOUT_FULL = """<!-- ABOUT: CINEMATIC EDITORIAL CANVAS -->
    ...
    <svg class="absolute inset-0 w-full h-full pointer-events-none z-[50]" id="timeline-svg" viewBox="0 0 1400 2700" preserveAspectRatio="xMidYMid meet">
      <defs>
        ...
        <marker id="arrow-tip" viewBox="0 0 12 12" refX="9" refY="6" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
          <path d="M 2 2 L 9 6 L 2 10" fill="none" stroke="#1E293B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
        </marker>
      ...
      <path id="seg-0" class="journey-path" d="" fill="none" stroke="#1e293b" stroke-width="2.2" stroke-opacity="0.85" stroke-linecap="round" stroke-linejoin="round" />
      <circle id="n0-end" class="journey-node" cx="0" cy="0" r="5" fill="#421835" stroke="white" stroke-width="1.5" filter="url(#glow-sm)" opacity="0"/>

      <!-- SEG 1: Girl illustration → Orbital -->
      <path id="seg-1" class="journey-path" d="" fill="none" stroke="#1e293b" stroke-width="2.2" stroke-opacity="0.85" stroke-linecap="round" stroke-linejoin="round" />
      <circle id="n1-end" class="journey-node" cx="0" cy="0" r="5" fill="#421835" stroke="white" stroke-width="1.5" filter="url(#glow-sm)" opacity="0"/>

      <!-- SEG 2: Orbital → LinkedIn card -->
      <path id="seg-2" class="journey-path" d="" fill="none" stroke="#1e293b" stroke-width="2.2" stroke-opacity="0.85" stroke-linecap="round" stroke-linejoin="round" />
      <circle id="n2-end" class="journey-node" cx="0" cy="0" r="5" fill="#421835" stroke="white" stroke-width="1.5" filter="url(#glow-sm)" opacity="0"/>

      <!-- SEG 3: LinkedIn card → GitHub card -->
      <path id="seg-3" class="journey-path" d="" fill="none" stroke="#1e293b" stroke-width="2.2" stroke-opacity="0.85" stroke-linecap="round" stroke-linejoin="round" />
      <circle id="n3-end" class="journey-node" cx="0" cy="0" r="5" fill="#421835" stroke="white" stroke-width="1.5" filter="url(#glow-sm)" opacity="0"/>

      <!-- SEG 4: GitHub card → Shavira card -->
      <path id="seg-4" class="journey-path" d="" fill="none" stroke="#1e293b" stroke-width="2.2" stroke-opacity="0.85" stroke-linecap="round" stroke-linejoin="round" />
      <circle id="n4-end" class="journey-node" cx="0" cy="0" r="5" fill="#421835" stroke="white" stroke-width="1.5" filter="url(#glow-sm)" opacity="0"/>
    </svg>
...
content = re.sub(r'<!-- ABOUT: CINEMATIC EDITORIAL CANVAS -->.*?</section>', NEW_ABOUT_FULL, content, flags=re.DOTALL)

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(content)

print("Successfully restored full #about section HTML container and all elements.")
