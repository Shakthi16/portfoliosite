...
start_marker = '<!-- ==================== 1. ABOUT ME: INTERACTIVE 3-PAGE JOURNAL BOOK ==================== -->'
end_marker = '<!-- ==================== 2. EDITORIAL CANVAS (#about) ==================== -->'

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + OPENED_JOURNAL_SPREAD_HTML + '\n\n' + content[end_idx:]
    print("Successfully replaced with OPENED JOURNAL SPREAD!")
else:
