...
# We will completely overwrite the <section id="home"> to guarantee perfect layout.
new_home = """<section id="home" style="position: relative; overflow: hidden; height: 100vh; min-height: 700px; width: 100vw; background-color: #fdfaf8; background-image: linear-gradient(#f0e9e4 1px, transparent 1px), linear-gradient(90deg, #f0e9e4 1px, transparent 1px); background-size: 50px 50px;">
  ...
  <div style="position: absolute; top: 48%; left: 50%; transform: translate(-50%, -50%); text-align: center; z-index: 1; width: 100%;">
    <h1 style="font-family: 'Alex Brush', cursive !important; font-size: clamp(70px, 8vw, 110px); font-weight: 400; color: #421835; margin: 0; line-height: 1;">Shakthi Sri</h1>
    <div style="font-family: 'Manrope', sans-serif !important; font-size: clamp(10px, 1vw, 12px); font-weight: 700; letter-spacing: 0.5em; text-transform: uppercase; color: #582a4b; margin-top: 20px;">DESIGN &bull; SECURE &bull; EMPOWER</div>
  ...
  <!-- 1. ID CARD (Top Left - scaled down slightly) -->
  ...
  <!-- 2. Desk Setup Image (Mid Left - pushed out) -->
  ...
  <!-- 3. "Today's focus" Note (Top Mid-Left - moved higher) -->
  ...
  <!-- 8. "LESSONS I'M STILL LEARNING" (Mid Left - pushed higher to avoid terminal) -->
  <div class="floating-sticker" style="top: 42%; left: 18%; z-index: 7; transform: rotate(2deg); scale: 0.85;">
  ...
  <div class="floating-sticker" style="top: 25%; right: 4%; width: 220px; height: 300px; z-index: 10; scale: 0.9;">
    ...
    <div class="polaroid-collage" style="position: absolute; top: 10px; right: 0; transform: rotate(12deg); width: 110px; padding: 8px 8px 25px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.08); z-index: 2;">
      <div style="position: absolute; top: 5px; left: 10px; width: 10px; height: 10px; border-radius: 50%; background: #602548; box-shadow: inset -2px -2px 4px rgba(0,0,0,0.3); z-index: 10;"></div>
    ...
    <div class="polaroid-collage" style="position: absolute; top: 140px; right: 10px; transform: rotate(5deg); width: 100px; padding: 8px 8px 30px; background: #fff; box-shadow: 0 8px 20px rgba(0,0,0,0.1); z-index: 4;">
      <div style="width: 84px; height: 100px; overflow: hidden; background: #111; position: relative;">
        ...
        <div style="position: absolute; top: 40%; left: 50%; transform: translate(-50%, -50%); color: #e879f9; font-family: 'Alex Brush', cursive !important; font-size: 18px; text-shadow: 0 0 10px #e879f9; white-space: nowrap; text-align: center; line-height: 1;">trust<br>the<br>process</div>
      </div>
    </div>
  </div>

  <!-- 10. Terminal Window (Bottom Left Corner - ANCHORED TO BOTTOM) -->
  ...
  <!-- 11. Dark Quote Note (Bottom Mid-Left - ANCHORED TO BOTTOM) -->
  <div class="floating-sticker" style="bottom: 5%; left: 22%; z-index: 12; transform: rotate(3deg); transform-origin: bottom center; scale: 0.9;">
    ...
    <div style="width: 140px; padding: 25px 20px; background: #4f2940; border-radius: 4px; box-shadow: 0 10px 25px rgba(0,0,0,0.15);">
      ...
      <div style="text-align: right; margin-top: 15px; font-family: 'Alex Brush', cursive !important; font-size: 18px; color: #c49eb3;">- Shakthi Sri</div>
      <div style="position: absolute; bottom: 15px; right: 15px; font-size: 12px; color: #c49eb3;">♡</div>
    </div>
  </div>

  <!-- 12. AGNI C2 Card (Bottom Center - ANCHORED TO BOTTOM) -->
  ...
  <!-- 13. Tech Stack Grid (Bottom Right Center - ANCHORED TO BOTTOM) -->
  ...
  <!-- 14. The Interactive Folder Fan-Out! (Bottom Right side - ANCHORED TO BOTTOM) -->
  ...
  <!-- 16. Music Player (Bottom Right - ANCHORED TO BOTTOM) -->
...
print("Home section rewritten to use bottom anchors and scaling to fix off-screen issues.")
